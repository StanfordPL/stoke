...
VALIDATOR_AUTOGEN= src/validator/handlers.h \
									 src/validator/switch.h \
								   src/validator/switch.cc \
									 src/validator/validator.switch \
									 src/validator/supported.switch \
									 src/validator/autogen
...
validator_clean:
	rm -f $(VALIDATOR_AUTOGEN) src/validator/autogen.hi src/validator/autogen.o tests/validator/handlers.h
...
src/validator/legacy_handlers.o: src/validator/legacy_handlers.cc $(VALIDATOR_AUTOGEN)
