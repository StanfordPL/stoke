...
src/validator/legacy_handlers.o: src/validator/legacy_handlers.cc src/validator/legacy_handlers.o
...
bin/stoke_test: tools/stoke_test.cc $(SRC_OBJ) $(TEST_OBJ) $(wildcard tests/*.h) $(wildcard tests/*/*.h) tests/validator/handlers.h
...
validator_clean:
	rm -f src/validator/validator.switch src/validator/switch.h src/validator/switch.cc src/validator/supported.switch src/validator/autogen src/validator/autogen.hi src/validator/autogen.o tests/validator/handlers.h src/validator/handlers.h
