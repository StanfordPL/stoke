...
.fannkuchredux:                  #        0x201e0  0      OPC=0     
  ...
  leal 0x1(%rdx), %r10d          #  413   0x204e8  4      OPC=1066  
  sarl $0x1, %r10d               #  414   0x204ec  3      OPC=2097  
...
.L_204c0:                        #        0x20504  0      OPC=0     
  leal (%r14,%rdx,4), %edx       #  429   0x20504  4      OPC=1066  
  movl %r11d, %ecx               #  430   0x20508  3      OPC=1157  
  xorl %eax, %eax                #  431   0x2050b  2      OPC=3758  
  movq %r12, %rsi                #  432   0x2050d  3      OPC=1162  
  jmpq .L_20500                  #  433   0x20510  5      OPC=930   
  nop                            #  434   0x20515  1      OPC=1343  
  nop                            #  435   0x20516  1      OPC=1343  
  nop                            #  436   0x20517  1      OPC=1343  
  nop                            #  437   0x20518  1      OPC=1343  
  nop                            #  438   0x20519  1      OPC=1343  
  nop                            #  439   0x2051a  1      OPC=1343  
  nop                            #  440   0x2051b  1      OPC=1343  
  nop                            #  441   0x2051c  1      OPC=1343  
  nop                            #  442   0x2051d  1      OPC=1343  
  nop                            #  443   0x2051e  1      OPC=1343  
  nop                            #  444   0x2051f  1      OPC=1343  
  nop                            #  445   0x20520  1      OPC=1343  
  nop                            #  446   0x20521  1      OPC=1343  
  nop                            #  447   0x20522  1      OPC=1343  
  nop                            #  448   0x20523  1      OPC=1343  
.L_204e0:                        #        0x20529  0      OPC=0     
  movl %ecx, %esi                #  454   0x20529  2      OPC=1157  
  movl %esi, %esi                #  455   0x2052b  2      OPC=1157  
  movl (%r15,%rsi,1), %r9d       #  456   0x2052d  4      OPC=1156  
  nop                            #  457   0x20531  1      OPC=1343  
  nop                            #  458   0x20532  1      OPC=1343  
  nop                            #  459   0x20533  1      OPC=1343  
  nop                            #  460   0x20534  1      OPC=1343  
  nop                            #  461   0x20535  1      OPC=1343  
  nop                            #  462   0x20536  1      OPC=1343  
  nop                            #  463   0x20537  1      OPC=1343  
  nop                            #  464   0x20538  1      OPC=1343  
  nop                            #  465   0x20539  1      OPC=1343  
  nop                            #  466   0x2053a  1      OPC=1343  
  nop                            #  467   0x2053b  1      OPC=1343  
  nop                            #  468   0x2053c  1      OPC=1343  
  nop                            #  469   0x2053d  1      OPC=1343  
  nop                            #  470   0x2053e  1      OPC=1343  
  nop                            #  471   0x2053f  1      OPC=1343  
  nop                            #  472   0x20540  1      OPC=1343  
  nop                            #  473   0x20541  1      OPC=1343  
  nop                            #  474   0x20542  1      OPC=1343  
  nop                            #  475   0x20543  1      OPC=1343  
  nop                            #  476   0x20544  1      OPC=1343  
  nop                            #  477   0x20545  1      OPC=1343  
  nop                            #  478   0x20546  1      OPC=1343  
  nop                            #  479   0x20547  1      OPC=1343  
  nop                            #  480   0x20548  1      OPC=1343  
.L_20500:                        #        0x20549  0      OPC=0     
  movl %edx, %ebx                #  481   0x20549  2      OPC=1157  
  movl %ebx, %ebx                #  482   0x2054b  2      OPC=1157  
  movl (%r15,%rbx,1), %r8d       #  483   0x2054d  4      OPC=1156  
  movl %esi, %esi                #  484   0x20551  2      OPC=1157  
  movl %r8d, (%r15,%rsi,1)       #  485   0x20553  4      OPC=1136  
  movl %ebx, %ebx                #  486   0x20557  2      OPC=1157  
  movl %r9d, (%r15,%rbx,1)       #  487   0x20559  4      OPC=1136  
  addl $0x1, %eax                #  488   0x2055d  3      OPC=65    
  subl $0x4, %edx                #  489   0x20560  3      OPC=2384  
  addl $0x4, %ecx                #  490   0x20563  3      OPC=65    
  cmpl %r10d, %eax               #  491   0x20566  3      OPC=472   
  jne .L_204e0                   #  492   0x20569  6      OPC=963   
  ...
  nop                            #  500   0x20584  1      OPC=1343  
  nop                            #  501   0x20585  1      OPC=1343  
  nop                            #  502   0x20586  1      OPC=1343  
  nop                            #  503   0x20587  1      OPC=1343  
  nop                            #  504   0x20588  1      OPC=1343  
  nop                            #  505   0x20589  1      OPC=1343  
  nop                            #  506   0x2058a  1      OPC=1343  
.L_20540:                        #        0x20595  0      OPC=0     
  movl %edx, %r9d                #  517   0x20595  3      OPC=1157  
  leal 0x1(%rdx), %r10d          #  518   0x20598  4      OPC=1066  
  sarl $0x1, %r10d               #  519   0x2059c  3      OPC=2097  
