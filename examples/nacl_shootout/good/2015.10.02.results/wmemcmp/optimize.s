...
.wmemcmp:                       #        0x14f2a0  0      OPC=<label>         
  xorl %eax, %eax               #  1     0x14f2a0  2      OPC=xorl_r32_r32    //1
  xorl %eax, %edx               #  2     0x14f2a2  2      OPC=xorl_r32_r32_1  
  je .L_14f300                  #  3     0x14f2a4  2      OPC=je_label        
  orl $0x0, %edi                #  4     0x14f2a6  6      OPC=orl_r32_imm32   //2
  ...
  jmpq .L_14f320                #  12    0x14f2bd  2      OPC=jmpq_label      //3
  nop                           #  13    0x14f2bf  1      OPC=nop             //4
.L_14f2c0:                      #        0x14f2c0  0      OPC=<label>         //5
...
.L_14f2e0:                      #        0x14f2e0  0      OPC=<label>         //7
  decl %edx                     #  33    0x14f2e0  2      OPC=decl_r32        
  jnz .L_14f2c0                 # CHANGED
  nop                           #  35    0x14f2e4  1      OPC=nop             //8
...
.L_14f300:                      #        0x14f300  0      OPC=<label>         //9
  ...
  retq
.L_14f320:                      #        0x14f320  0      OPC=<label>         //10
