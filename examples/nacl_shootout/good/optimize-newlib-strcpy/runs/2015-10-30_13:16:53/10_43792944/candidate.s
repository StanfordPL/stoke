...
.strcpy:                         #        0x1267e0  0      OPC=<label>         
  ...
  movq %rsi, %rdx                #  5     0x1267e5  3      OPC=movq_r64_r64    
  nop                            #  6     0x1267e8  1      OPC=nop             
  nop                            #  7     0x1267e9  1      OPC=nop             
  nop                            #  8     0x1267ea  1      OPC=nop             
  nop                            #  9     0x1267eb  1      OPC=nop             
  movl %eax, %ecx                #  10    0x1267ec  2      OPC=movl_r32_r32_1  
  orl %edx, %edi                 #  11    0x1267ee  2      OPC=orl_r32_r32_1   
  ...
  nop                            #  17    0x1267fa  1      OPC=nop             
  nop                            #  18    0x1267fb  1      OPC=nop             
  nop                            #  19    0x1267fc  1      OPC=nop             
  nop                            #  20    0x1267fd  1      OPC=nop             
  nop                            #  21    0x1267fe  1      OPC=nop             
  nop                            #  22    0x1267ff  1      OPC=nop             
  xorl $0xffffffe0, %eax         #  23    0x126800  5      OPC=xorl_eax_imm32  
  ...
  jne .L_126860                  #  37    0x126812  6      OPC=jne_label_1     
...
.L_126820:                       #        0x126820  0      OPC=<label>         
  nop                            #  46    0x126820  1      OPC=nop             
  nop                            #  47    0x126821  1      OPC=nop             
  nop                            #  48    0x126822  1      OPC=nop             
  nop                            #  49    0x126823  1      OPC=nop             
  nop                            #  50    0x126824  1      OPC=nop             
  nop                            #  51    0x126825  1      OPC=nop             
  ...
  orb %dil, %dl                  #  59    0x12682d  3      OPC=orb_r8_r8       
  ...
  subb %ch, %ch                  #  68    0x126838  2      OPC=subb_rh_rh_1    
  ...
  nop                            #  76    0x126841  1      OPC=nop             
  nop                            #  77    0x126842  1      OPC=nop             
  nop                            #  78    0x126843  1      OPC=nop             
  je .L_126820                   #  79    0x126844  6      OPC=je_label_1      
  ...
  nop                            #  86    0x126850  1      OPC=nop             
  nop                            #  87    0x126851  1      OPC=nop             
  nop                            #  88    0x126852  1      OPC=nop             
  nop                            #  89    0x126853  1      OPC=nop             
  nop                            #  90    0x126854  1      OPC=nop             
  nop                            #  91    0x126855  1      OPC=nop             
  nop                            #  92    0x126856  1      OPC=nop             
  nop                            #  93    0x126857  1      OPC=nop             
  nop                            #  94    0x126858  1      OPC=nop             
  nop                            #  95    0x126859  1      OPC=nop             
  nop                            #  96    0x12685a  1      OPC=nop             
  nop                            #  97    0x12685b  1      OPC=nop             
  nop                            #  98    0x12685c  1      OPC=nop             
  nop                            #  99    0x12685d  1      OPC=nop             
  nop                            #  100   0x12685e  1      OPC=nop             
  nop                            #  101   0x12685f  1      OPC=nop             
.L_126860:                       #        0x126860  0      OPC=<label>         
  incl %edx                      #  102   0x126860  2      OPC=incl_r32        
  movsbw -0x1(%r15,%rdx,1), %si  #  103   0x126862  7      OPC=movsbw_r16_m8   
  addl $0x1, %ecx                #  104   0x126869  6      OPC=addl_r32_imm32  
  movb %sil, -0x1(%r15,%rcx,1)   #  105   0x12686f  5      OPC=movb_m8_r8      
  testb %sil, %sil               #  106   0x126874  3      OPC=testb_r8_r8     
  jne .L_126860                  #  107   0x126877  6      OPC=jne_label_1     
