...
.L_12c240:                    #        0x12c240  0      OPC=<label>        
  ...
  addl $0x1, %edi             #  29    0x12c243  3      OPC=addl_r32_imm8  
  addl $0x1, %esi             #  30    0x12c246  3      OPC=addl_r32_imm8  
  cmpl %eax, %edx             #  31    0x12c249  2      OPC=cmpl_r32_r32   
  je .L_12c2a0                #  32    0x12c24b  2      OPC=je_label       
  nop                         #  33    0x12c24d  1      OPC=nop            
...
.L_12c260:                    #        0x12c260  0      OPC=<label>        
  ...
  popq %r11                   #  58    0x12c271  2      OPC=popq_r64_1     
  andl $0xe0, %r11d           #  59    0x12c273  4      OPC=andl_r32_imm8  
  addq %r15, %r11             #  60    0x12c277  3      OPC=addq_r64_r64   
  jmpq %r11                   #  61    0x12c27a  3      OPC=jmpq_r64       
...
.L_12c280:                    #        0x12c280  0      OPC=<label>        
  ...
  addl $0x1, %eax             #  66    0x12c283  3      OPC=addl_r32_imm8  
  nop                         #  67    0x12c286  1      OPC=nop            
  nop                         #  68    0x12c287  1      OPC=nop            
  nop                         #  69    0x12c288  1      OPC=nop            
  nop                         #  70    0x12c289  1      OPC=nop            
  nop                         #  71    0x12c28a  1      OPC=nop            
  nop                         #  72    0x12c28b  1      OPC=nop            
  nop                         #  73    0x12c28c  1      OPC=nop            
  nop                         #  74    0x12c28d  1      OPC=nop            
  nop                         #  75    0x12c28e  1      OPC=nop            
  nop                         #  76    0x12c28f  1      OPC=nop            
  nop                         #  77    0x12c290  1      OPC=nop            
  nop                         #  78    0x12c291  1      OPC=nop            
...
.L_12c2a0:                    #        0x12c2a0  0      OPC=<label>        
  ...
  popq %r11                   #  96    0x12c2a9  2      OPC=popq_r64_1     
  andl $0xe0, %r11d           #  97    0x12c2ab  4      OPC=andl_r32_imm8  
  addq %r15, %r11             #  98    0x12c2af  3      OPC=addq_r64_r64   
  jmpq %r11                   #  99    0x12c2b2  3      OPC=jmpq_r64       
