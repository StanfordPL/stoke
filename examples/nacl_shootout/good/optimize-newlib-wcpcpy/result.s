...
.L_140ae0:                      #        0x140ae0  0      OPC=<label>         
  ...
  addl $0x4, %edi               #  36    0x140aed  3      OPC=addl_r32_imm8   
  movl %edx, -0x4(%r15,%rdi,1)  #  37    0x140af0  5      OPC=movl_m32_r32    
  shll $0x1, %edx               #  38    0x140af5  3      OPC=shll_r32_imm8   
  jne .L_140ae0                 #  39    0x140af8  2      OPC=jne_label       
  nop                           #  40    0x140afa  1      OPC=nop             
  nop                           #  41    0x140afb  1      OPC=nop             
  nop                           #  42    0x140afc  1      OPC=nop             
  nop                           #  43    0x140afd  1      OPC=nop             
  nop                           #  44    0x140afe  1      OPC=nop             
  nop                           #  45    0x140aff  1      OPC=nop             
  nop                           #  46    0x140b00  1      OPC=nop             
  nop                           #  47    0x140b01  1      OPC=nop             
  nop                           #  48    0x140b02  1      OPC=nop             
  nop                           #  49    0x140b03  1      OPC=nop             
  nop                           #  50    0x140b04  1      OPC=nop             
  nop                           #  51    0x140b05  1      OPC=nop             
  nop                           #  52    0x140b06  1      OPC=nop             
  nop                           #  53    0x140b07  1      OPC=nop             
  popq %r11                     #  54    0x140b08  2      OPC=popq_r64_1      
  andl $0xe0, %r11d             #  55    0x140b0a  4      OPC=andl_r32_imm8   
  addq %r15, %r11               #  56    0x140b0e  3      OPC=addq_r64_r64    
  jmpq %r11                     #  57    0x140b11  3      OPC=jmpq_r64        
