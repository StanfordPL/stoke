...
.L_141100:                  #        0x141100  0      OPC=<label>         
  ...
  addl $0x4, %edi           #  54    0x141116  3      OPC=addl_r32_imm8   
...
.L_141120:                  #        0x141120  0      OPC=<label>         
  movl %esi, %esi           #  62    0x141120  2      OPC=movl_r32_r32_1  
  ...
  popq %r11                 #  81    0x141141  2      OPC=popq_r64_1      
  andl $0xe0, %r11d         #  82    0x141143  4      OPC=andl_r32_imm8   
  addq %r15, %r11           #  83    0x141147  3      OPC=addq_r64_r64    
  jmpq %r11                 #  84    0x14114a  3      OPC=jmpq_r64        
  nop                       #  85    0x14114d  1      OPC=nop             
  nop                       #  86    0x14114e  1      OPC=nop             
  nop                       #  87    0x14114f  1      OPC=nop             
  nop                       #  88    0x141150  1      OPC=nop             
  nop                       #  89    0x141151  1      OPC=nop             
  nop                       #  90    0x141152  1      OPC=nop             
  nop                       #  91    0x141153  1      OPC=nop             
  nop                       #  92    0x141154  1      OPC=nop             
  nop                       #  93    0x141155  1      OPC=nop             
  nop                       #  94    0x141156  1      OPC=nop             
  nop                       #  95    0x141157  1      OPC=nop             
  nop                       #  96    0x141158  1      OPC=nop             
  nop                       #  97    0x141159  1      OPC=nop             
  nop                       #  98    0x14115a  1      OPC=nop             
  nop                       #  99    0x14115b  1      OPC=nop             
  nop                       #  100   0x14115c  1      OPC=nop             
  nop                       #  101   0x14115d  1      OPC=nop             
  nop                       #  102   0x14115e  1      OPC=nop             
  nop                       #  103   0x14115f  1      OPC=nop             
.L_141160:                  #        0x141160  0      OPC=<label>         
  subl %edx, %eax           #  104   0x141160  2      OPC=subl_r32_r32    
  popq %r11                 #  105   0x141162  2      OPC=popq_r64_1      
  andl $0xe0, %r11d         #  106   0x141164  4      OPC=andl_r32_imm8   
  addq %r15, %r11           #  107   0x141168  3      OPC=addq_r64_r64    
  jmpq %r11                 #  108   0x14116b  3      OPC=jmpq_r64        
