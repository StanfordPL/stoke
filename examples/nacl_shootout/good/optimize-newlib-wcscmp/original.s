...
.L_141120:                  #        0x141120  0      OPC=<label>         
  ...
  popq %r11                 #  69    0x141137  2      OPC=popq_r64_1      
  ...
  andl $0xffffffe0, %r11d   #  77    0x141140  7      OPC=andl_r32_imm32  
  nop                       #  78    0x141147  1      OPC=nop             
  nop                       #  79    0x141148  1      OPC=nop             
  nop                       #  80    0x141149  1      OPC=nop             
  nop                       #  81    0x14114a  1      OPC=nop             
  addq %r15, %r11           #  82    0x14114b  3      OPC=addq_r64_r64    
  jmpq %r11                 #  83    0x14114e  3      OPC=jmpq_r64        
  ...
  nop                       #  104   0x141165  1      OPC=nop             
  nop                       #  105   0x141166  1      OPC=nop             
.L_141160:                  #        0x141167  0      OPC=<label>         
  subl %edx, %eax           #  106   0x141167  2      OPC=subl_r32_r32    
  popq %r11                 #  107   0x141169  2      OPC=popq_r64_1      
  andl $0xffffffe0, %r11d   #  108   0x14116b  7      OPC=andl_r32_imm32  
  nop                       #  109   0x141172  1      OPC=nop             
  nop                       #  110   0x141173  1      OPC=nop             
  nop                       #  111   0x141174  1      OPC=nop             
  nop                       #  112   0x141175  1      OPC=nop             
  addq %r15, %r11           #  113   0x141176  3      OPC=addq_r64_r64    
  jmpq %r11                 #  114   0x141179  3      OPC=jmpq_r64        
