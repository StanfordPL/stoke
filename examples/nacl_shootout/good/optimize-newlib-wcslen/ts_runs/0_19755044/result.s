...
.wcslen:                    #        0x142ca0  0      OPC=<label>         
  ...
  xorl %eax, %eax           #  7     0x142ca6  2      OPC=xorl_r32_r32    
  nop                       #  8     0x142ca8  1      OPC=nop             
  nop                       #  9     0x142ca9  1      OPC=nop             
  nop                       #  10    0x142caa  1      OPC=nop             
  nop                       #  11    0x142cab  1      OPC=nop             
  orl %edi, %edi            #  12    0x142cac  2      OPC=orl_r32_r32_1   
  movl (%r15,%rdi,1), %ecx  #  13    0x142cae  4      OPC=movl_r32_m32    
  testl %ecx, %ecx          #  14    0x142cb2  2      OPC=testl_r32_r32   
  nop                       #  15    0x142cb4  1      OPC=nop             
  nop                       #  16    0x142cb5  1      OPC=nop             
  nop                       #  17    0x142cb6  1      OPC=nop             
  je .L_142ce0              #  18    0x142cb7  2      OPC=je_label        
  movq %rdi, %rdx           #  19    0x142cb9  3      OPC=movq_r64_r64_1  
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>         
  ...
  subl %edi, %eax           #  33    0x142cd1  2      OPC=subl_r32_r32_1  
  shrl $0x2, %eax           #  34    0x142cd3  3      OPC=shrl_r32_imm8   
