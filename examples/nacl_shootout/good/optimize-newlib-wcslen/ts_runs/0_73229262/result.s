...
.wcslen:                    #        0x142ca0  0      OPC=<label>        
  ...
  movl %edi, %edi           #  4     0x142ca5  2      OPC=movl_r32_r32   
  movl (%r15,%rdi,1), %ecx  #  5     0x142ca7  4      OPC=movl_r32_m32   
  movq %rdi, %rdx           #  6     0x142cab  3      OPC=movq_r64_r64   
  testl %ecx, %ecx          #  7     0x142cae  2      OPC=testl_r32_r32  
  je .L_142ce0              #  8     0x142cb0  2      OPC=je_label       
  nopl %eax                 #  9     0x142cb2  3      OPC=nopl_r32       
  nop                       #  10    0x142cb5  1      OPC=nop            
  nop                       #  11    0x142cb6  1      OPC=nop            
  nop                       #  12    0x142cb7  1      OPC=nop            
  nop                       #  13    0x142cb8  1      OPC=nop            
  nop                       #  14    0x142cb9  1      OPC=nop            
  nop                       #  15    0x142cba  1      OPC=nop            
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>        
  ...
  xorl %edx, %eax           #  25    0x142ccb  2      OPC=xorl_r32_r32   
  subl %edi, %eax           #  26    0x142ccd  2      OPC=subl_r32_r32   
  sarl $0x2, %eax           #  27    0x142ccf  3      OPC=sarl_r32_imm8  
  nop                       #  28    0x142cd2  1      OPC=nop            
  nop                       #  29    0x142cd3  1      OPC=nop            
  nop                       #  30    0x142cd4  1      OPC=nop            
  nop                       #  31    0x142cd5  1      OPC=nop            
  nop                       #  32    0x142cd6  1      OPC=nop            
  nop                       #  33    0x142cd7  1      OPC=nop            
  nop                       #  34    0x142cd8  1      OPC=nop            
  nop                       #  35    0x142cd9  1      OPC=nop            
  nopl %eax                 #  36    0x142cda  3      OPC=nopl_r32       
  nop                       #  37    0x142cdd  1      OPC=nop            
  nop                       #  38    0x142cde  1      OPC=nop            
  nop                       #  39    0x142cdf  1      OPC=nop            
.L_142ce0:                  #        0x142ce0  0      OPC=<label>        
  popq %r11                 #  40    0x142ce0  2      OPC=popq_r64_1     
  andl $0xe0, %r11d         #  41    0x142ce2  4      OPC=andl_r32_imm8  
  addq %r15, %r11           #  42    0x142ce6  3      OPC=addq_r64_r64   
  jmpq %r11                 #  43    0x142ce9  3      OPC=jmpq_r64       
