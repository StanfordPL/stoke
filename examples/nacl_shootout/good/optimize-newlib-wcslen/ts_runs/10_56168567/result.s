...
.wcslen:                    #        0x142ca0  0      OPC=<label>         
  ...
  movl %edi, %edx           #  4     0x142ca4  2      OPC=movl_r32_r32_1  
  xorl %eax, %eax           #  5     0x142ca6  2      OPC=xorl_r32_r32    
  movl %edi, %edi           #  6     0x142ca8  2      OPC=movl_r32_r32    
  movl (%r15,%rdi,1), %ecx  #  7     0x142caa  4      OPC=movl_r32_m32    
  testl %ecx, %ecx          #  8     0x142cae  2      OPC=testl_r32_r32   
  je .L_142ce0              #  9     0x142cb0  2      OPC=je_label        
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>         
  ...
  nopl %eax                 #  36    0x142cd7  3      OPC=nopl_r32        
