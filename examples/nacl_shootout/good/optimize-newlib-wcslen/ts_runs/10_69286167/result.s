...
.wcslen:                    #        0x142ca0  0      OPC=<label>        
  ...
  xorl %eax, %eax           #  12    0x142cab  2      OPC=xorl_r32_r32   
  movl %edi, %edx           #  13    0x142cad  2      OPC=movl_r32_r32   
  movl (%r15,%rdx,1), %ecx  #  14    0x142caf  4      OPC=movl_r32_m32   
  ...
  je .L_142ce0              #  23    0x142cbc  2      OPC=je_label       
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>        
  ...
  orl %edx, %eax            #  31    0x142ccc  2      OPC=orl_r32_r32_1  
  subl %edi, %eax           #  32    0x142cce  2      OPC=subl_r32_r32   
  ...
  nop                       #  43    0x142cda  1      OPC=nop            
  nop                       #  44    0x142cdb  1      OPC=nop            
  nop                       #  45    0x142cdc  1      OPC=nop            
  sarl $0x2, %eax           #  46    0x142cdd  3      OPC=sarl_r32_imm8  
