...
.wcslen:                    #        0x142ca0  0      OPC=<label>         
  ...
  andl %edi, %edi           #  4     0x142ca4  2      OPC=andl_r32_r32    
  movl (%r15,%rdi,1), %ecx  #  5     0x142ca6  4      OPC=movl_r32_m32    
  nop                       #  6     0x142caa  1      OPC=nop             
  nop                       #  7     0x142cab  1      OPC=nop             
  testl %ecx, %ecx          #  8     0x142cac  2      OPC=testl_r32_r32   
  je .L_142ce0              #  9     0x142cae  2      OPC=je_label        
  ...
  movl %edi, %edx           #  19    0x142cb9  2      OPC=movl_r32_r32_1  
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>         
  ...
  testl %eax, %eax          #  27    0x142cc7  2      OPC=testl_r32_r32   
  jne .L_142cc0             #  28    0x142cc9  2      OPC=jne_label       
  movl %edx, %eax           #  29    0x142ccb  2      OPC=movl_r32_r32    
  subl %edi, %eax           #  30    0x142ccd  2      OPC=subl_r32_r32    
  nop                       #  31    0x142ccf  1      OPC=nop             
  sarl $0x2, %eax           #  32    0x142cd0  3      OPC=sarl_r32_imm8   
  ...
  nop                       #  41    0x142cdb  1      OPC=nop             
  nop                       #  42    0x142cdc  1      OPC=nop             
  nop                       #  43    0x142cdd  1      OPC=nop             
