...
.wcslen:                    #        0x142ca0  0      OPC=<label>        
  ...
  xorl %eax, %eax           #  4     0x142ca5  2      OPC=xorl_r32_r32   
  movl %edi, %edi           #  5     0x142ca7  2      OPC=movl_r32_r32   
  movl (%r15,%rdi,1), %ecx  #  6     0x142ca9  4      OPC=movl_r32_m32   
  movq %rdi, %rdx           #  7     0x142cad  3      OPC=movq_r64_r64   
  testl %ecx, %ecx          #  8     0x142cb0  2      OPC=testl_r32_r32  
  je .L_142ce0              #  9     0x142cb2  2      OPC=je_label       
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>        
  ...
  sarl $0x2, %eax           #  28    0x142ccf  3      OPC=sarl_r32_imm8  
...
.L_142ce0:                  #        0x142ce0  0      OPC=<label>        
  ...
  andl $0xe0, %r11d         #  44    0x142ce2  4      OPC=andl_r32_imm8  
  addq %r15, %r11           #  45    0x142ce6  3      OPC=addq_r64_r64   
  jmpq %r11                 #  46    0x142ce9  3      OPC=jmpq_r64       
