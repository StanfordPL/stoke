...
.wcslen:                    #        0x142ca0  0      OPC=<label>        
  ...
  movl %edi, %edx           #  2     0x142ca2  2      OPC=movl_r32_r32   
  movl (%r15,%rdx,1), %ecx  #  3     0x142ca4  4      OPC=movl_r32_m32   
  testl %ecx, %ecx          #  4     0x142ca8  2      OPC=testl_r32_r32  
  ...
  je .L_142ce0              #  14    0x142cb3  2      OPC=je_label       
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>        
  ...
  movl %edx, %eax           #  33    0x142cce  2      OPC=movl_r32_r32   
  nop                       #  34    0x142cd0  1      OPC=nop            
  nop                       #  35    0x142cd1  1      OPC=nop            
  nop                       #  36    0x142cd2  1      OPC=nop            
  subl %edi, %eax           #  37    0x142cd3  2      OPC=subl_r32_r32   
  nop                       #  38    0x142cd5  1      OPC=nop            
  nop                       #  39    0x142cd6  1      OPC=nop            
  shrl $0x2, %eax           #  40    0x142cd7  3      OPC=shrl_r32_imm8  
...
.L_142ce0:                  #        0x142ce0  0      OPC=<label>        
  ...
  popq %r11                 #  50    0x142ce3  2      OPC=popq_r64_1     
  andl $0xe0, %r11d         #  51    0x142ce5  4      OPC=andl_r32_imm8  
  addq %r15, %r11           #  52    0x142ce9  3      OPC=addq_r64_r64   
  jmpq %r11                 #  53    0x142cec  3      OPC=jmpq_r64       
