...
.wcslen:                    #        0x142ca0  0      OPC=<label>         
  ...
  movl %edi, %edi           #  7     0x142ca8  2      OPC=movl_r32_r32_1  
  movl (%r15,%rdi,1), %ecx  #  8     0x142caa  4      OPC=movl_r32_m32    
  xorl %eax, %eax           #  9     0x142cae  2      OPC=xorl_r32_r32    
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>         
  ...
  subl %edi, %eax           #  30    0x142cce  2      OPC=subl_r32_r32_1  
  nop                       #  31    0x142cd0  1      OPC=nop             
  shrl $0x2, %eax           #  32    0x142cd1  3      OPC=shrl_r32_imm8   
