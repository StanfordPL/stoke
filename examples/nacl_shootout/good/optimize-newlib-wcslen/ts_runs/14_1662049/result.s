...
.wcslen:                    #        0x142ca0  0      OPC=<label>        
  ...
  nopl %eax                 #  4     0x142ca8  3      OPC=nopl_r32       
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>        
  ...
  orl %edx, %eax            #  26    0x142ccb  2      OPC=orl_r32_r32    
  ...
  nopl %eax                 #  38    0x142cd9  3      OPC=nopl_r32       
  nop                       #  39    0x142cdc  1      OPC=nop            
  sarl $0x2, %eax           #  40    0x142cdd  3      OPC=sarl_r32_imm8  
.L_142ce0:                  #        0x142ce0  0      OPC=<label>        
  nop                       #  41    0x142ce0  1      OPC=nop            
  popq %r11                 #  42    0x142ce1  2      OPC=popq_r64_1     
  andl $0xe0, %r11d         #  43    0x142ce3  4      OPC=andl_r32_imm8  
  addq %r15, %r11           #  44    0x142ce7  3      OPC=addq_r64_r64   
  jmpq %r11                 #  45    0x142cea  3      OPC=jmpq_r64       
