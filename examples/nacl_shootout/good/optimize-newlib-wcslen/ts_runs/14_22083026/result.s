...
.wcslen:                    #        0x142ca0  0      OPC=<label>         
  ...
  nopl %eax                 #  2     0x142ca2  3      OPC=nopl_r32        
  andl %edi, %edi           #  3     0x142ca5  2      OPC=andl_r32_r32_1  
  movl (%r15,%rdi,1), %ecx  #  4     0x142ca7  4      OPC=movl_r32_m32    
  testl %ecx, %ecx          #  5     0x142cab  2      OPC=testl_r32_r32   
  movq %rdi, %rdx           #  6     0x142cad  3      OPC=movq_r64_r64    
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>         
  ...
  nopl %eax                 #  39    0x142cdc  3      OPC=nopl_r32        
