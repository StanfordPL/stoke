...
.wcslen:                    #        0x142ca0  0      OPC=<label>         
  ...
  movl %edi, %edx           #  2     0x142ca1  2      OPC=movl_r32_r32    
  movl (%r15,%rdx,1), %ecx  #  3     0x142ca3  4      OPC=movl_r32_m32    
  nop                       #  4     0x142ca7  1      OPC=nop             
  nop                       #  5     0x142ca8  1      OPC=nop             
  nop                       #  6     0x142ca9  1      OPC=nop             
  nop                       #  7     0x142caa  1      OPC=nop             
  nop                       #  8     0x142cab  1      OPC=nop             
  xorl %eax, %eax           #  9     0x142cac  2      OPC=xorl_r32_r32    
  negq %rcx                 #  10    0x142cae  3      OPC=negq_r64        
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>         
  ...
  negq %rax                 #  27    0x142cc7  3      OPC=negq_r64        
  ...
  subl %edi, %eax           #  35    0x142cd3  2      OPC=subl_r32_r32_1  
...
.L_142ce0:                  #        0x142ce0  0      OPC=<label>         
  ...
  sarl $0x2, %eax           #  50    0x142ce3  3      OPC=sarl_r32_imm8   
  ...
  nop                       #  57    0x142cec  1      OPC=nop             
  nop                       #  58    0x142ced  1      OPC=nop             
  nop                       #  59    0x142cee  1      OPC=nop             
  nop                       #  60    0x142cef  1      OPC=nop             
  popq %r11                 #  61    0x142cf0  2      OPC=popq_r64_1      
  andl $0xe0, %r11d         #  62    0x142cf2  4      OPC=andl_r32_imm8   
  addq %r15, %r11           #  63    0x142cf6  3      OPC=addq_r64_r64    
  jmpq %r11                 #  64    0x142cf9  3      OPC=jmpq_r64        
