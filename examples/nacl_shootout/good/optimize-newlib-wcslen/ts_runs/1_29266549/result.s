...
.wcslen:                    #        0x142ca0  0      OPC=<label>        
  ...
  movq %rdi, %rdx           #  3     0x142ca2  3      OPC=movq_r64_r64   
  movl %edx, %edi           #  4     0x142ca5  2      OPC=movl_r32_r32   
  movl (%r15,%rdi,1), %ecx  #  5     0x142ca7  4      OPC=movl_r32_m32   
  xorl %eax, %eax           #  6     0x142cab  2      OPC=xorl_r32_r32   
  testl %ecx, %ecx          #  7     0x142cad  2      OPC=testl_r32_r32  
  je .L_142ce0              #  8     0x142caf  2      OPC=je_label       
  nop                       #  9     0x142cb1  1      OPC=nop            
  andb $0x80, %al           #  10    0x142cb2  2      OPC=andb_al_imm8   
  xorw %ax, %di             #  11    0x142cb4  3      OPC=xorw_r16_r16   
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>        
  ...
  movl %edx, %eax           #  26    0x142ccc  2      OPC=movl_r32_r32   
  subl %edi, %eax           #  27    0x142cce  2      OPC=subl_r32_r32   
  ...
  nopl %eax                 #  33    0x142cd5  3      OPC=nopl_r32       
  nop                       #  34    0x142cd8  1      OPC=nop            
  nop                       #  35    0x142cd9  1      OPC=nop            
  nop                       #  36    0x142cda  1      OPC=nop            
  nop                       #  37    0x142cdb  1      OPC=nop            
  sarw $0x2, %ax            #  38    0x142cdc  4      OPC=sarw_r16_imm8  
.L_142ce0:                  #        0x142ce0  0      OPC=<label>        
  nop                       #  39    0x142ce0  1      OPC=nop            
  popq %r11                 #  40    0x142ce1  2      OPC=popq_r64_1     
  andl $0xe0, %r11d         #  41    0x142ce3  4      OPC=andl_r32_imm8  
  addq %r15, %r11           #  42    0x142ce7  3      OPC=addq_r64_r64   
  jmpq %r11                 #  43    0x142cea  3      OPC=jmpq_r64       
