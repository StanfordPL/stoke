...
.wcslen:                    #        0x142ca0  0      OPC=<label>        
  orl %edi, %edi            #  1     0x142ca0  2      OPC=orl_r32_r32_1  
  ...
  nopl %eax                 #  12    0x142cb3  3      OPC=nopl_r32       
  nop                       #  13    0x142cb6  1      OPC=nop            
  nop                       #  14    0x142cb7  1      OPC=nop            
  nop                       #  15    0x142cb8  1      OPC=nop            
  movq %rdi, %rdx           #  16    0x142cb9  3      OPC=movq_r64_r64   
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>        
  ...
  movl %edx, %eax           #  25    0x142ccb  2      OPC=movl_r32_r32   
  subl %edi, %eax           #  26    0x142ccd  2      OPC=subl_r32_r32   
  nop                       #  27    0x142ccf  1      OPC=nop            
  ...
  shlb $0x80, %ah           #  38    0x142cdc  3      OPC=shlb_rh_imm8   
