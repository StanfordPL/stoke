...
.wcslen:                    #        0x142ca0  0      OPC=<label>         
  ...
  movl %ecx, %eax           #  6     0x142ca9  2      OPC=movl_r32_r32_1  
  ...
  nop                       #  12    0x142cb0  1      OPC=nop             
  nop                       #  13    0x142cb1  1      OPC=nop             
  ...
  orl %eax, %eax            #  21    0x142cb9  2      OPC=orl_r32_r32_1   
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>         
  ...
  movl %edx, %eax           #  32    0x142ccd  2      OPC=movl_r32_r32_1  
  ...
  subl %edi, %eax           #  44    0x142cda  2      OPC=subl_r32_r32_1  
  nop                       #  45    0x142cdc  1      OPC=nop             
  nop                       #  46    0x142cdd  1      OPC=nop             
  nop                       #  47    0x142cde  1      OPC=nop             
  nop                       #  48    0x142cdf  1      OPC=nop             
.L_142ce0:                  #        0x142ce0  0      OPC=<label>         
  sarw $0x2, %ax            #  49    0x142ce0  4      OPC=sarw_r16_imm8   
  popq %r11                 #  50    0x142ce4  2      OPC=popq_r64_1      
  andl $0xe0, %r11d         #  51    0x142ce6  4      OPC=andl_r32_imm8   
  addq %r15, %r11           #  52    0x142cea  3      OPC=addq_r64_r64    
  jmpq %r11                 #  53    0x142ced  3      OPC=jmpq_r64        
