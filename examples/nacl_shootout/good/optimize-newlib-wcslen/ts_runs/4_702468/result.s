...
.wcslen:                    #        0x142ca0  0      OPC=<label>         
  ...
  movl %edi, %r10d          #  5     0x142ca9  3      OPC=movl_r32_r32    
  testl %ecx, %ecx          #  6     0x142cac  2      OPC=testl_r32_r32   
  je .L_142ce0              #  7     0x142cae  2      OPC=je_label        
  movq %rdi, %rdx           #  8     0x142cb0  3      OPC=movq_r64_r64_1  
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>         
  ...
  subl %r10d, %eax          #  27    0x142ccd  3      OPC=subl_r32_r32    
  shrl $0x2, %eax           #  28    0x142cd0  3      OPC=shrl_r32_imm8   
