...
.wcslen:                    #        0x142ca0  0      OPC=<label>        
  ...
  movq %rdi, %rdx           #  7     0x142ca7  3      OPC=movq_r64_r64   
  movl %edi, %edi           #  8     0x142caa  2      OPC=movl_r32_r32   
  movl (%r15,%rdi,1), %ecx  #  9     0x142cac  4      OPC=movl_r32_m32   
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>        
  ...
  movl %edx, %edx           #  29    0x142ccc  2      OPC=movl_r32_r32   
  movl %edx, %eax           #  30    0x142cce  2      OPC=movl_r32_r32   
  subl %edi, %eax           #  31    0x142cd0  2      OPC=subl_r32_r32   
