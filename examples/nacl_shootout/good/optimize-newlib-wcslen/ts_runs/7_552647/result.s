...
.wcslen:                    #        0x142ca0  0      OPC=<label>        
  ...
  movq %rdi, %rdx           #  4     0x142ca3  3      OPC=movq_r64_r64   
  orl %edi, %edi            #  5     0x142ca6  2      OPC=orl_r32_r32    
  movl (%r15,%rdi,1), %ecx  #  6     0x142ca8  4      OPC=movl_r32_m32   
  xorl %eax, %eax           #  7     0x142cac  2      OPC=xorl_r32_r32   
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>        
  ...
  subq %rdi, %rax           #  32    0x142cd0  3      OPC=subq_r64_r64   
  nop                       #  33    0x142cd3  1      OPC=nop            
  sarl $0x2, %eax           #  34    0x142cd4  3      OPC=sarl_r32_imm8  
