...
.wcslen:                    #        0x142ca0  0      OPC=<label>         
  ...
  xorl %eax, %eax           #  16    0x142caf  2      OPC=xorl_r32_r32    
  movl %edi, %edx           #  17    0x142cb1  2      OPC=movl_r32_r32    
  movl (%r15,%rdx,1), %ecx  #  18    0x142cb3  4      OPC=movl_r32_m32    
  nop                       #  19    0x142cb7  1      OPC=nop             
  nop                       #  20    0x142cb8  1      OPC=nop             
  nop                       #  21    0x142cb9  1      OPC=nop             
  nop                       #  22    0x142cba  1      OPC=nop             
  nop                       #  23    0x142cbb  1      OPC=nop             
  testl %ecx, %ecx          #  24    0x142cbc  2      OPC=testl_r32_r32   
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>         
  ...
  addl %edx, %eax           #  30    0x142ccb  2      OPC=addl_r32_r32    
  subl %edi, %eax           #  31    0x142ccd  2      OPC=subl_r32_r32_1  
  ...
  nop                       #  40    0x142cd7  1      OPC=nop             
  nop                       #  41    0x142cd8  1      OPC=nop             
  nop                       #  42    0x142cd9  1      OPC=nop             
  shrw $0x2, %ax            #  43    0x142cda  4      OPC=shrw_r16_imm8   
  nop                       #  44    0x142cde  1      OPC=nop             
  nop                       #  45    0x142cdf  1      OPC=nop             
.L_142ce0:                  #        0x142ce0  0      OPC=<label>         
  popq %r11                 #  46    0x142ce0  2      OPC=popq_r64_1      
  andl $0xe0, %r11d         #  47    0x142ce2  4      OPC=andl_r32_imm8   
  addq %r15, %r11           #  48    0x142ce6  3      OPC=addq_r64_r64    
  jmpq %r11                 #  49    0x142ce9  3      OPC=jmpq_r64        
