...
.wcslen:                    #        0x142ca0  0      OPC=<label>         
  ...
  movq %rdi, %rdx           #  2     0x142ca2  3      OPC=movq_r64_r64_1  
  subl %eax, %edi           #  3     0x142ca5  2      OPC=subl_r32_r32_1  
  movl (%r15,%rdi,1), %ecx  #  4     0x142ca7  4      OPC=movl_r32_m32    
  nop                       #  5     0x142cab  1      OPC=nop             
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>         
  ...
  addl %edx, %eax           #  30    0x142ccd  2      OPC=addl_r32_r32_1  
  nop                       #  31    0x142ccf  1      OPC=nop             
  nop                       #  32    0x142cd0  1      OPC=nop             
  subl %edi, %eax           #  33    0x142cd1  2      OPC=subl_r32_r32    
  ...
  shrl $0x2, %eax           #  41    0x142cda  3      OPC=shrl_r32_imm8   
...
.L_142ce0:                  #        0x142ce0  0      OPC=<label>         
  ...
  popq %r11                 #  52    0x142ce7  2      OPC=popq_r64_1      
  andl $0xe0, %r11d         #  53    0x142ce9  4      OPC=andl_r32_imm8   
  addq %r15, %r11           #  54    0x142ced  3      OPC=addq_r64_r64    
  jmpq %r11                 #  55    0x142cf0  3      OPC=jmpq_r64        
