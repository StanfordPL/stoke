...
.wcslen:                    #        0x142ca0  0      OPC=<label>         
  ...
  movl %edi, %edi           #  4     0x142ca4  2      OPC=movl_r32_r32_1  
  ...
  nop                       #  9     0x142cae  1      OPC=nop             
  nop                       #  10    0x142caf  1      OPC=nop             
  nop                       #  11    0x142cb0  1      OPC=nop             
  movq %rdi, %rdx           #  12    0x142cb1  3      OPC=movq_r64_r64    
  je .L_142ce0              #  13    0x142cb4  2      OPC=je_label        
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>         
  ...
  orq %rdx, %rax            #  29    0x142ccc  3      OPC=orq_r64_r64     
  subl %edi, %eax           #  30    0x142ccf  2      OPC=subl_r32_r32    
  nop                       #  31    0x142cd1  1      OPC=nop             
  nopl %eax                 #  32    0x142cd2  3      OPC=nopl_r32        
  nop                       #  33    0x142cd5  1      OPC=nop             
  sarl $0x2, %eax           #  34    0x142cd6  3      OPC=sarl_r32_imm8   
...
.L_142ce0:                  #        0x142ce0  0      OPC=<label>         
  nop                       #  42    0x142ce0  1      OPC=nop             
  nop                       #  43    0x142ce1  1      OPC=nop             
  nop                       #  44    0x142ce2  1      OPC=nop             
  popq %r11                 #  45    0x142ce3  2      OPC=popq_r64_1      
  andl $0xe0, %r11d         #  46    0x142ce5  4      OPC=andl_r32_imm8   
  addq %r15, %r11           #  47    0x142ce9  3      OPC=addq_r64_r64    
  jmpq %r11                 #  48    0x142cec  3      OPC=jmpq_r64        
