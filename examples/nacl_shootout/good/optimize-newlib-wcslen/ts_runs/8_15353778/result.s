...
.wcslen:                    #        0x142ca0  0      OPC=<label>         
  ...
  xorl %ecx, %eax           #  4     0x142ca8  2      OPC=xorl_r32_r32_1  
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>         
  ...
  nop                       #  35    0x142cd0  1      OPC=nop             
  nop                       #  36    0x142cd1  1      OPC=nop             
  nop                       #  37    0x142cd2  1      OPC=nop             
  nop                       #  38    0x142cd3  1      OPC=nop             
  nop                       #  39    0x142cd4  1      OPC=nop             
  nop                       #  40    0x142cd5  1      OPC=nop             
  nop                       #  41    0x142cd6  1      OPC=nop             
  nop                       #  42    0x142cd7  1      OPC=nop             
  nop                       #  43    0x142cd8  1      OPC=nop             
  subl %edi, %edx           #  44    0x142cd9  2      OPC=subl_r32_r32_1  
  orl %edx, %eax            #  45    0x142cdb  2      OPC=orl_r32_r32     
  nopl %eax                 #  46    0x142cdd  3      OPC=nopl_r32        
.L_142ce0:                  #        0x142ce0  0      OPC=<label>         
  ...
  shrl $0x2, %eax           #  52    0x142ce5  3      OPC=shrl_r32_imm8   
  popq %r11                 #  53    0x142ce8  2      OPC=popq_r64_1      
  andl $0xe0, %r11d         #  54    0x142cea  4      OPC=andl_r32_imm8   
  addq %r15, %r11           #  55    0x142cee  3      OPC=addq_r64_r64    
  jmpq %r11                 #  56    0x142cf1  3      OPC=jmpq_r64        
