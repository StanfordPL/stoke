...
.wcslen:                    #        0x142ca0  0      OPC=<label>         
  movl %edi, %edi           #  1     0x142ca0  2      OPC=movl_r32_r32_1  
  andb %dil, %dil           #  2     0x142ca2  3      OPC=andb_r8_r8_1    
  nop                       #  3     0x142ca5  1      OPC=nop             
  xorl %eax, %eax           #  4     0x142ca6  2      OPC=xorl_r32_r32    
  nop                       #  5     0x142ca8  1      OPC=nop             
  movl %edi, %edx           #  6     0x142ca9  2      OPC=movl_r32_r32_1  
  movl (%r15,%rdx,1), %ecx  #  7     0x142cab  4      OPC=movl_r32_m32    
  nop                       #  8     0x142caf  1      OPC=nop             
  testl %ecx, %ecx          #  9     0x142cb0  2      OPC=testl_r32_r32   
  je .L_142ce0              #  10    0x142cb2  2      OPC=je_label        
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>         
  ...
  subl %edi, %eax           #  34    0x142cd3  2      OPC=subl_r32_r32    
