...
.wcslen:                    #        0x142ca0  0      OPC=<label>         
  ...
  movl %edi, %edx           #  2     0x142ca2  2      OPC=movl_r32_r32_1  
  andl %edx, %edi           #  3     0x142ca4  2      OPC=andl_r32_r32_1  
  movl (%r15,%rdi,1), %ecx  #  4     0x142ca6  4      OPC=movl_r32_m32    
  nop                       #  5     0x142caa  1      OPC=nop             
  testl %ecx, %ecx          #  6     0x142cab  2      OPC=testl_r32_r32   
  je .L_142ce0              #  7     0x142cad  2      OPC=je_label        
  ...
  nopl %eax                 #  13    0x142cb4  3      OPC=nopl_r32        
...
.L_142cc0:                  #        0x142cc0  0      OPC=<label>         
  ...
  negq %rax                 #  25    0x142cc7  3      OPC=negq_r64        
  jne .L_142cc0             #  26    0x142cca  2      OPC=jne_label       
  movl %edx, %eax           #  27    0x142ccc  2      OPC=movl_r32_r32_1  
  subl %edi, %eax           #  28    0x142cce  2      OPC=subl_r32_r32    
  ...
  sarl $0x2, %eax           #  41    0x142cdc  3      OPC=sarl_r32_imm8   
  nop                       #  42    0x142cdf  1      OPC=nop             
.L_142ce0:                  #        0x142ce0  0      OPC=<label>         
  nop                       #  43    0x142ce0  1      OPC=nop             
  nop                       #  44    0x142ce1  1      OPC=nop             
  popq %r11                 #  45    0x142ce2  2      OPC=popq_r64_1      
  andl $0xe0, %r11d         #  46    0x142ce4  4      OPC=andl_r32_imm8   
  addq %r15, %r11           #  47    0x142ce8  3      OPC=addq_r64_r64    
  jmpq %r11                 #  48    0x142ceb  3      OPC=jmpq_r64        
