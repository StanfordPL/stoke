...
.wcsnlen:                   #        0x142d00  0      OPC=<label>        
  andl %edi, %edi           #  1     0x142d00  2      OPC=andl_r32_r32   
...
.L_142d20:                  #        0x142d20  0      OPC=<label>        
  ...
  nop                       #  23    0x142d25  1      OPC=nop            
  nop                       #  24    0x142d26  1      OPC=nop            
  nop                       #  25    0x142d27  1      OPC=nop            
  nop                       #  26    0x142d28  1      OPC=nop            
  nop                       #  27    0x142d29  1      OPC=nop            
  ...
  nop                       #  35    0x142d31  1      OPC=nop            
  nop                       #  36    0x142d32  1      OPC=nop            
  nop                       #  37    0x142d33  1      OPC=nop            
  nop                       #  38    0x142d34  1      OPC=nop            
  nop                       #  39    0x142d35  1      OPC=nop            
  nop                       #  40    0x142d36  1      OPC=nop            
  nop                       #  41    0x142d37  1      OPC=nop            
  nop                       #  42    0x142d38  1      OPC=nop            
  nop                       #  43    0x142d39  1      OPC=nop            
  nop                       #  44    0x142d3a  1      OPC=nop            
  nop                       #  45    0x142d3b  1      OPC=nop            
  nop                       #  46    0x142d3c  1      OPC=nop            
  subl $0x1, %esi           #  47    0x142d3d  3      OPC=subl_r32_imm8  
.L_142d40:                  #        0x142d40  0      OPC=<label>        
  ...
  nop                       #  51    0x142d49  1      OPC=nop            
  jne .L_142d20             #  52    0x142d4a  2      OPC=jne_label      
...
.L_142d80:                  #        0x142d80  0      OPC=<label>        
  ...
  popq %r11                 #  95    0x142d82  2      OPC=popq_r64_1     
  andl $0xe0, %r11d         #  96    0x142d84  4      OPC=andl_r32_imm8  
  addq %r15, %r11           #  97    0x142d88  3      OPC=addq_r64_r64   
  jmpq %r11                 #  98    0x142d8b  3      OPC=jmpq_r64       
