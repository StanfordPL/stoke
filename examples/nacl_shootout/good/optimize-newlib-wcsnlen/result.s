...
.L_142d60:                  #        0x142d60  0      OPC=<label>        
  ...
  andl $0xe0, %r11d         #  74    0x142d67  4      OPC=andl_r32_imm8  
  addq %r15, %r11           #  75    0x142d6b  3      OPC=addq_r64_r64   
  jmpq %r11                 #  76    0x142d6e  3      OPC=jmpq_r64       
  nop                       #  77    0x142d71  1      OPC=nop            
  nop                       #  78    0x142d72  1      OPC=nop            
  nop                       #  79    0x142d73  1      OPC=nop            
  nop                       #  80    0x142d74  1      OPC=nop            
  nop                       #  81    0x142d75  1      OPC=nop            
  nop                       #  82    0x142d76  1      OPC=nop            
  nop                       #  83    0x142d77  1      OPC=nop            
  nop                       #  84    0x142d78  1      OPC=nop            
  nop                       #  85    0x142d79  1      OPC=nop            
  nop                       #  86    0x142d7a  1      OPC=nop            
  nop                       #  87    0x142d7b  1      OPC=nop            
  nop                       #  88    0x142d7c  1      OPC=nop            
  nop                       #  89    0x142d7d  1      OPC=nop            
  nop                       #  90    0x142d7e  1      OPC=nop            
  nop                       #  91    0x142d7f  1      OPC=nop            
.L_142d80:                  #        0x142d80  0      OPC=<label>        
  xorl %eax, %eax           #  92    0x142d80  2      OPC=xorl_r32_r32   
  popq %r11                 #  93    0x142d82  2      OPC=popq_r64_1     
  andl $0xe0, %r11d         #  94    0x142d84  4      OPC=andl_r32_imm8  
  addq %r15, %r11           #  95    0x142d88  3      OPC=addq_r64_r64   
  jmpq %r11                 #  96    0x142d8b  3      OPC=jmpq_r64       
