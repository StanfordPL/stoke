...
.wcsrchr:                   #        0x1438c0  0      OPC=<label>        
  ...
  testl %ecx, %ecx          #  4     0x1438c9  2      OPC=testl_r32_r32  
  je .L_143900              #  5     0x1438cb  2      OPC=je_label       
  xchgw %ax, %ax            #  6     0x1438cd  2      OPC=xchgw_ax_r16   
  ...
  movl %edi, %edi           #  22    0x1438de  2      OPC=movl_r32_r32   
...
.L_143940:                  #        0x143940  0      OPC=<label>        
  ...
  jbe .L_143920             #  100   0x143945  2      OPC=jbe_label      
...
.L_143980:                  #        0x143980  0      OPC=<label>        
  popq %r11                 #  157   0x143980  2      OPC=popq_r64_1     
  andl $0xe0, %r11d         #  158   0x143982  4      OPC=andl_r32_imm8  
  addq %r15, %r11           #  159   0x143986  3      OPC=addq_r64_r64   
  jmpq %r11                 #  160   0x143989  3      OPC=jmpq_r64       
  nop                       #  161   0x14398c  1      OPC=nop            
  nop                       #  162   0x14398d  1      OPC=nop            
  nop                       #  163   0x14398e  1      OPC=nop            
  nop                       #  164   0x14398f  1      OPC=nop            
  nop                       #  165   0x143990  1      OPC=nop            
  nop                       #  166   0x143991  1      OPC=nop            
  nop                       #  167   0x143992  1      OPC=nop            
  nop                       #  168   0x143993  1      OPC=nop            
  nop                       #  169   0x143994  1      OPC=nop            
  nop                       #  170   0x143995  1      OPC=nop            
  nop                       #  171   0x143996  1      OPC=nop            
  nop                       #  172   0x143997  1      OPC=nop            
  nop                       #  173   0x143998  1      OPC=nop            
  nop                       #  174   0x143999  1      OPC=nop            
  nop                       #  175   0x14399a  1      OPC=nop            
  nop                       #  176   0x14399b  1      OPC=nop            
  nop                       #  177   0x14399c  1      OPC=nop            
  nop                       #  178   0x14399d  1      OPC=nop            
  nop                       #  179   0x14399e  1      OPC=nop            
  nop                       #  180   0x14399f  1      OPC=nop            
.L_1439a0:                  #        0x1439a0  0      OPC=<label>        
  popq %r11                 #  181   0x1439a0  2      OPC=popq_r64_1     
  andl $0xe0, %r11d         #  182   0x1439a2  4      OPC=andl_r32_imm8  
  addq %r15, %r11           #  183   0x1439a6  3      OPC=addq_r64_r64   
  jmpq %r11                 #  184   0x1439a9  3      OPC=jmpq_r64       
