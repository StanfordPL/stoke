...
.wcsrchr:                   #        0x1438c0  0      OPC=<label>        
  ...
  nop                       #  7     0x1438cf  1      OPC=nop            
  nop                       #  8     0x1438d0  1      OPC=nop            
...
.L_1438e0:                  #        0x1438e0  0      OPC=<label>        
  movl %eax, %eax           #  24    0x1438e0  2      OPC=movl_r32_r32   
  addl $0x4, %eax           #  25    0x1438e2  3      OPC=addl_r32_imm8  
  movl (%r15,%rax,1), %edx  #  26    0x1438e5  4      OPC=movl_r32_m32   
  testl %edx, %edx          #  27    0x1438e9  2      OPC=testl_r32_r32  
  jne .L_1438e0             #  28    0x1438eb  2      OPC=jne_label      
  cmpl %eax, %edi           #  29    0x1438ed  2      OPC=cmpl_r32_r32   
  ja .L_143960              #  30    0x1438ef  2      OPC=ja_label       
...
.L_143900:                  #        0x143900  0      OPC=<label>        
  testl %esi, %esi          #  46    0x143900  2      OPC=testl_r32_r32  
  jne .L_143940             #  47    0x143902  2      OPC=jne_label      
  jmpq .L_1439a0            #  48    0x143904  5      OPC=jmpq_label_1   
...
.L_143920:                  #        0x143920  0      OPC=<label>        
  movl %eax, %eax           #  72    0x143920  2      OPC=movl_r32_r32   
  ...
  nop                       #  93    0x14393a  1      OPC=nop            
  nop                       #  94    0x14393b  1      OPC=nop            
  nop                       #  95    0x14393c  1      OPC=nop            
  nop                       #  96    0x14393d  1      OPC=nop            
  nop                       #  97    0x14393e  1      OPC=nop            
  nop                       #  98    0x14393f  1      OPC=nop            
.L_143940:                  #        0x143940  0      OPC=<label>        
  subl $0x4, %eax           #  99    0x143940  3      OPC=subl_r32_imm8  
  cmpl %eax, %edi           #  100   0x143943  2      OPC=cmpl_r32_r32   
  jbe .L_143920             #  101   0x143945  2      OPC=jbe_label      
...
.L_143960:                  #        0x143960  0      OPC=<label>        
  xorl %eax, %eax           #  127   0x143960  2      OPC=xorl_r32_r32   
...
.L_143980:                  #        0x143980  0      OPC=<label>        
  ...
  nop                       #  162   0x14398c  1      OPC=nop            
  nop                       #  163   0x14398d  1      OPC=nop            
  nop                       #  164   0x14398e  1      OPC=nop            
  nop                       #  165   0x14398f  1      OPC=nop            
  nop                       #  166   0x143990  1      OPC=nop            
  nop                       #  167   0x143991  1      OPC=nop            
  nop                       #  168   0x143992  1      OPC=nop            
  nop                       #  169   0x143993  1      OPC=nop            
  nop                       #  170   0x143994  1      OPC=nop            
  nop                       #  171   0x143995  1      OPC=nop            
  nop                       #  172   0x143996  1      OPC=nop            
  nop                       #  173   0x143997  1      OPC=nop            
  nop                       #  174   0x143998  1      OPC=nop            
  nop                       #  175   0x143999  1      OPC=nop            
  nop                       #  176   0x14399a  1      OPC=nop            
  nop                       #  177   0x14399b  1      OPC=nop            
  nop                       #  178   0x14399c  1      OPC=nop            
  nop                       #  179   0x14399d  1      OPC=nop            
  nop                       #  180   0x14399e  1      OPC=nop            
  nop                       #  181   0x14399f  1      OPC=nop            
.L_1439a0:                  #        0x1439a0  0      OPC=<label>        
  popq %r11                 #  182   0x1439a0  2      OPC=popq_r64_1     
  andl $0xe0, %r11d         #  183   0x1439a2  4      OPC=andl_r32_imm8  
  addq %r15, %r11           #  184   0x1439a6  3      OPC=addq_r64_r64   
  jmpq %r11                 #  185   0x1439a9  3      OPC=jmpq_r64       
