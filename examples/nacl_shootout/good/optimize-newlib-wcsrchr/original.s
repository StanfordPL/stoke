...
.L_143980:                  #        0x143980  0      OPC=<label>         
  ...
  andl $0xffffffe0, %r11d   #  158   0x143982  7      OPC=andl_r32_imm32  
  nop                       #  159   0x143989  1      OPC=nop             
  nop                       #  160   0x14398a  1      OPC=nop             
  nop                       #  161   0x14398b  1      OPC=nop             
  nop                       #  162   0x14398c  1      OPC=nop             
  addq %r15, %r11           #  163   0x14398d  3      OPC=addq_r64_r64    
  jmpq %r11                 #  164   0x143990  3      OPC=jmpq_r64        
...
.L_1439a0:                  #        0x1439a7  0      OPC=<label>         
  popq %r11                 #  185   0x1439a7  2      OPC=popq_r64_1      
  andl $0xffffffe0, %r11d   #  186   0x1439a9  7      OPC=andl_r32_imm32  
  nop                       #  187   0x1439b0  1      OPC=nop             
  nop                       #  188   0x1439b1  1      OPC=nop             
  nop                       #  189   0x1439b2  1      OPC=nop             
  nop                       #  190   0x1439b3  1      OPC=nop             
  addq %r15, %r11           #  191   0x1439b4  3      OPC=addq_r64_r64    
  jmpq %r11                 #  192   0x1439b7  3      OPC=jmpq_r64        
