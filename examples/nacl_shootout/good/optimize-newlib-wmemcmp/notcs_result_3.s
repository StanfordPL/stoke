...
.wmemcmp:                       #        0x14f2a0  0      OPC=<label>        
  ...
  movl %esi, %esi               #  2     0x14f2a2  2      OPC=movl_r32_r32   
  movl %edi, %edi               #  3     0x14f2a4  2      OPC=movl_r32_r32   
...
.L_14f300:                      #        0x14f300  0      OPC=<label>        
  ...
  andl $0xe0, %r11d             #  63    0x14f304  4      OPC=andl_r32_imm8  
  addq %r15, %r11               #  64    0x14f308  3      OPC=addq_r64_r64   
  jmpq %r11                     #  65    0x14f30b  3      OPC=jmpq_r64       
  nop                           #  66    0x14f30e  1      OPC=nop            
  nop                           #  67    0x14f30f  1      OPC=nop            
  nop                           #  68    0x14f310  1      OPC=nop            
  nop                           #  69    0x14f311  1      OPC=nop            
  nop                           #  70    0x14f312  1      OPC=nop            
  nop                           #  71    0x14f313  1      OPC=nop            
  nop                           #  72    0x14f314  1      OPC=nop            
  nop                           #  73    0x14f315  1      OPC=nop            
  nop                           #  74    0x14f316  1      OPC=nop            
  nop                           #  75    0x14f317  1      OPC=nop            
  nop                           #  76    0x14f318  1      OPC=nop            
  nopl %eax                     #  77    0x14f319  3      OPC=nopl_r32       
  nop                           #  78    0x14f31c  1      OPC=nop            
  nop                           #  79    0x14f31d  1      OPC=nop            
  nop                           #  80    0x14f31e  1      OPC=nop            
  nop                           #  81    0x14f31f  1      OPC=nop            
.L_14f320:                      #        0x14f320  0      OPC=<label>        
  ...
  nop                           #  86    0x14f324  1      OPC=nop            
  setg %al                      #  87    0x14f325  3      OPC=setg_r8        
  leal -0x1(%rax,%rax,1), %eax  #  88    0x14f328  4      OPC=leal_r32_m16   
  popq %r11                     #  89    0x14f32c  2      OPC=popq_r64_1     
  andl $0xe0, %r11d             #  90    0x14f32e  4      OPC=andl_r32_imm8  
  addq %r15, %r11               #  91    0x14f332  3      OPC=addq_r64_r64   
  jmpq %r11                     #  92    0x14f335  3      OPC=jmpq_r64       
