...
.strcasecmp:                    #        0     0      OPC=<label>         
  movq 0x0(%rip), %r8           #  1     0     7      OPC=movq_r64_m64    
...
.L_18:                          #        0x18  0      OPC=<label>         
  ...
  movzbl -0x1(%rdi), %edx       #  15    0x1c  4      OPC=movzbl_r32_m8   
  movq %rdx, %rax               #  16    0x20  3      OPC=movq_r64_r64    
  movzbl 0x1(%r8,%rdx,1), %edx  #  17    0x23  6      OPC=movzbl_r32_m8   
  ...
  movzbl -0x1(%rsi), %ecx       #  23    0x39  4      OPC=movzbl_r32_m8   
  movq %rcx, %rdx               #  24    0x3d  3      OPC=movq_r64_r64    
  movzbl 0x1(%r8,%rcx,1), %ecx  #  25    0x40  6      OPC=movzbl_r32_m8   
