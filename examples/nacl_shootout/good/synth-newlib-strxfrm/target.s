...
.strxfrm:                   #        0     0      OPC=<label>        
  ...
  je .L_38                  #  3     0x5   2      OPC=je_label_1
  leal (%rsi), %esi
  movzbl (%r15, %rsi,1), %eax       #  4     0x7   3      OPC=movzbl_r32_m8  
  leaq 0x1(%rsi), %rcx      #  5     0xa   4      OPC=leaq_r64_m16   
  testb %al, %al            #  6     0xe   2      OPC=testb_r8_r8    
  leal (%rdi), %r8d
  movb %al, (%r15, %r8, 1)          #  7     0x10  2      OPC=movb_m8_r8     
  je .L_4c                  #  8     0x12  2      OPC=je_label_1
  addq %rdx, %rsi           #  9     0x14  3      OPC=addq_r64_r64   
  xorl %eax, %eax           #  10    0x17  2      OPC=xorl_r32_r32   
  jmpq .L_2f                #  11    0x19  2      OPC=jmpq_label_1
...
.L_20:                      #        0x20  0      OPC=<label>        
  ...
  leal -0x1(%rcx), %r8d
  movzbl (%r15, %r8, 1), %edx   #  18    0x24  4      OPC=movzbl_r32_m8  
  testb %dl, %dl            #  19    0x28  2      OPC=testb_r8_r8    
  leal (%rdi, %rax, 1), %r8d
  movb %dl, (%r15, %r8, 1)   #  20    0x2a  3      OPC=movb_m8_r8     
  je .L_4a                  #  21    0x2d  2      OPC=je_label_1
.L_2f:                      #        0x2f  0      OPC=<label>        
  addq $0x1, %rax           #  22    0x2f  4      OPC=addq_r64_imm8  
  cmpq %rsi, %rcx           #  23    0x33  3      OPC=cmpq_r64_r64   
  jne .L_20                 #  24    0x36  2      OPC=jne_label_1      
.L_38:                      #        0x38  0      OPC=<label>        
  leal (%rsi), %r8d
  cmpb $0x0, (%r15, %r8)         #  25    0x38  3      OPC=cmpb_m8_imm8   
  je .L_4a                  #  26    0x3b  2      OPC=je_label_1
  subq %rax, %rsi           #  27    0x3d  3      OPC=subq_r64_r64   
.L_40:                      #        0x40  0      OPC=<label>        
  addq $0x1, %rax           #  28    0x40  4      OPC=addq_r64_imm8  
  leal (%rsi, %rax), %r8d
  cmpb $0x0, (%r15, %r8, 1)  #  29    0x44  4      OPC=cmpb_m8_imm8   
  jne .L_40                 #  30    0x48  2      OPC=jne_label_1
