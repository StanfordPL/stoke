...
.wmemcmp:                       #        0     0      OPC=<label>        
  ...
  movl (%rdi), %r8d             #  3     0x5   3      OPC=movl_r32_m32   
  movl (%rsi), %ecx             #  4     0x8   2      OPC=movl_r32_m32   
...
.L_18:                          #        0x18  0      OPC=<label>        
  movl (%rdi,%rax,4), %r8d      #  14    0x18  4      OPC=movl_r32_m32   
  movl (%rsi,%rax,4), %ecx      #  15    0x1c  3      OPC=movl_r32_m32   
