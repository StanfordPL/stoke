...
.L_12c240:                    #        0x12c242  0      OPC=<label>        
  addl $0x1, %eax             #  30    0x12c242  3      OPC=addl_r32_imm8  
  addl $0x1, %edi             #  31    0x12c245  3      OPC=addl_r32_imm8  
  addl $0x1, %esi             #  32    0x12c248  3      OPC=addl_r32_imm8  
  cmpl %eax, %edx             #  33    0x12c24b  2      OPC=cmpl_r32_r32   
  je .L_12c2a0                #  34    0x12c24d  2      OPC=je_label       
  nop                         #  35    0x12c24f  1      OPC=nop            
  nop                         #  36    0x12c250  1      OPC=nop            
  nop                         #  37    0x12c251  1      OPC=nop            
  nop                         #  38    0x12c252  1      OPC=nop            
  ...
  nop                         #  52    0x12c260  1      OPC=nop            
  nop                         #  53    0x12c261  1      OPC=nop            
  nop                         #  54    0x12c262  1      OPC=nop            
.L_12c260:                    #        0x12c263  0      OPC=<label>        
  movl %esi, %esi             #  55    0x12c263  2      OPC=movl_r32_r32   
  movzbl (%r15,%rsi,1), %ecx  #  56    0x12c265  5      OPC=movzbl_r32_m8  
  testb %cl, %cl              #  57    0x12c26a  2      OPC=testb_r8_r8    
  movl %edi, %edi             #  58    0x12c26c  2      OPC=movl_r32_r32   
  movb %cl, (%r15,%rdi,1)     #  59    0x12c26e  4      OPC=movb_m8_r8     
  jne .L_12c240               #  60    0x12c272  2      OPC=jne_label      
  retq                        #  61    0x12c274  1      OPC=retq           
...
.L_12c280:                    #        0x12c278  0      OPC=<label>        
  ...
  nop                         #  83    0x12c28e  1      OPC=nop            
  nop                         #  84    0x12c28f  1      OPC=nop            
  nop                         #  85    0x12c290  1      OPC=nop            
  nop                         #  86    0x12c291  1      OPC=nop            
  nop                         #  87    0x12c292  1      OPC=nop            
  nop                         #  88    0x12c293  1      OPC=nop            
  nop                         #  89    0x12c294  1      OPC=nop            
  nop                         #  90    0x12c295  1      OPC=nop            
.L_12c2a0:                    #        0x12c296  0      OPC=<label>        
  movl %esi, %esi             #  91    0x12c296  2      OPC=movl_r32_r32   
  cmpb $0x0, (%r15,%rsi,1)    #  92    0x12c298  5      OPC=cmpb_m8_imm8   
  jne .L_12c280               #  93    0x12c29d  2      OPC=jne_label      
  retq                        #  94    0x12c29f  1      OPC=retq           
