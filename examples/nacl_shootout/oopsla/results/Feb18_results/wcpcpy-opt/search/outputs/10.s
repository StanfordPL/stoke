...
.L_140ae0:                  #        0x140ad7  0      OPC=<label>        
  movl %esi, %esi           #  23    0x140ad7  2      OPC=movl_r32_r32   
  movl (%r15,%rsi,1), %edx  #  24    0x140ad9  4      OPC=movl_r32_m32   
  movq %rdi, %rax           #  25    0x140add  3      OPC=movq_r64_r64   
  addl $0x4, %esi           #  26    0x140ae0  3      OPC=addl_r32_imm8  
  movl %edi, %edi           #  27    0x140ae3  2      OPC=movl_r32_r32   
  movl %edx, (%r15,%rdi,1)  #  28    0x140ae5  4      OPC=movl_m32_r32   
  addl $0x4, %edi           #  29    0x140ae9  3      OPC=addl_r32_imm8  
  testl %edx, %edx          #  30    0x140aec  2      OPC=testl_r32_r32  
  jne .L_140ae0             #  31    0x140aee  2      OPC=jne_label      
  retq                      #  32    0x140af0  1      OPC=retq           
