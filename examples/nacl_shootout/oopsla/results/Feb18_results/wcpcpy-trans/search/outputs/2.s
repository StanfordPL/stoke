...
.wcpcpy:                        #        0     0      OPC=<label>         
  ...
  nop                           #  2     0x1   1      OPC=nop             
  nop                           #  3     0x2   1      OPC=nop             
  movl %edi, %eax               #  4     0x3   2      OPC=movl_r32_r32_1  
  nop                           #  5     0x5   1      OPC=nop             
  jmpq .L_b                     #  6     0x6   2      OPC=jmpq_label      
.L_8:                           #        0x8   0      OPC=<label>         
  movq %rcx, %rax               #  7     0x8   3      OPC=movq_r64_r64    
.L_b:                           #        0xb   0      OPC=<label>         
  addl $0x4, %esi               #  8     0xb   3      OPC=addl_r32_imm8   
  movl -0x4(%r15,%rsi,1), %edx  #  9     0xe   5      OPC=movl_r32_m32    
  testl %edx, %edx              #  10    0x13  2      OPC=testl_r32_r32   
  leal 0x4(%rax), %ecx          #  11    0x15  3      OPC=leal_r32_m16    
