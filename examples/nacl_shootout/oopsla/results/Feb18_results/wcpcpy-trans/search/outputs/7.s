...
.wcpcpy:                        #        0     0      OPC=<label>         
  ...
  nop                           #  6     0x7   1      OPC=nop             
.L_8:                           #        0x8   0      OPC=<label>         
  movw %cx, %ax                 #  7     0x8   3      OPC=movw_r16_r16_1  
.L_b:                           #        0xb   0      OPC=<label>         
  leal 0x4(%rax), %ecx          #  8     0xb   3      OPC=leal_r32_m16    
  addl $0x4, %esi               #  9     0xe   3      OPC=addl_r32_imm8   
  movl -0x4(%r15,%rsi,1), %edx  #  10    0x11  5      OPC=movl_r32_m32    
  testl %edx, %edx              #  11    0x16  2      OPC=testl_r32_r32   
  leal -0x4(%rcx), %r8d         #  12    0x18  4      OPC=leal_r32_m64    
