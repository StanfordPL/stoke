...
.L_1412a0:                  #        0x1412a3  0      OPC=<label>        
  addl $0x4, %eax           #  34    0x1412a3  3      OPC=addl_r32_imm8  
...
.L_1412c0:                  #        0x1412b6  0      OPC=<label>        
  movl %eax, %eax           #  51    0x1412b6  2      OPC=movl_r32_r32   
  movl (%r15,%rax,1), %edx  #  52    0x1412b8  4      OPC=movl_r32_m32   
  cmpl %esi, %edx           #  53    0x1412bc  2      OPC=cmpl_r32_r32   
  je .L_1412e0              #  54    0x1412be  2      OPC=je_label       
  testl %edx, %edx          #  55    0x1412c0  2      OPC=testl_r32_r32  
  jne .L_1412a0             #  56    0x1412c2  2      OPC=jne_label      
  xorl %eax, %eax           #  57    0x1412c4  2      OPC=xorl_r32_r32   
...
.L_1412e0:                  #        0x1412cb  0      OPC=<label>        
  retq                      #  63    0x1412cb  1      OPC=retq           
