...
.L_1412a0:                  #        0x1412a2  0      OPC=<label>        
  addl $0x4, %eax           #  33    0x1412a2  3      OPC=addl_r32_imm8  
...
.L_1412c0:                  #        0x1412b2  0      OPC=<label>        
  movl %eax, %eax           #  47    0x1412b2  2      OPC=movl_r32_r32   
  movl (%r15,%rax,1), %edx  #  48    0x1412b4  4      OPC=movl_r32_m32   
  cmpl %esi, %edx           #  49    0x1412b8  2      OPC=cmpl_r32_r32   
  je .L_1412e0              #  50    0x1412ba  2      OPC=je_label       
  testl %edx, %edx          #  51    0x1412bc  2      OPC=testl_r32_r32  
  jne .L_1412a0             #  52    0x1412be  2      OPC=jne_label      
  xorl %eax, %eax           #  53    0x1412c0  2      OPC=xorl_r32_r32   
  ...
  nop                       #  60    0x1412c8  1      OPC=nop            
  nop                       #  61    0x1412c9  1      OPC=nop            
...
.L_1412e0:                  #        0x1412d3  0      OPC=<label>        
  retq                      #  71    0x1412d3  1      OPC=retq           
