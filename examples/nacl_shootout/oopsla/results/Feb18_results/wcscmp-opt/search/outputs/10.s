...
.wcscmp:                    #        0x1410e0  0      OPC=<label>         
  andl %esi, %esi           #  1     0x1410e0  2      OPC=andl_r32_r32_1  
...
.L_141100:                  #        0x141107  0      OPC=<label>         
  addl $0x4, %edi           #  37    0x141107  3      OPC=addl_r32_imm8   
...
.L_141120:                  #        0x141120  0      OPC=<label>         
  ...
  retq                      #  79    0x141143  1      OPC=retq            
  nop                       #  80    0x141144  1      OPC=nop             
  nop                       #  81    0x141145  1      OPC=nop             
  nop                       #  82    0x141146  1      OPC=nop             
  nop                       #  83    0x141147  1      OPC=nop             
  nop                       #  84    0x141148  1      OPC=nop             
  nop                       #  85    0x141149  1      OPC=nop             
  nop                       #  86    0x14114a  1      OPC=nop             
  nop                       #  87    0x14114b  1      OPC=nop             
  nop                       #  88    0x14114c  1      OPC=nop             
  nop                       #  89    0x14114d  1      OPC=nop             
  nop                       #  90    0x14114e  1      OPC=nop             
  nop                       #  91    0x14114f  1      OPC=nop             
  nop                       #  92    0x141150  1      OPC=nop             
  nop                       #  93    0x141151  1      OPC=nop             
  nop                       #  94    0x141152  1      OPC=nop             
  nop                       #  95    0x141153  1      OPC=nop             
  nop                       #  96    0x141154  1      OPC=nop             
.L_141160:                  #        0x141155  0      OPC=<label>         
  subl %edx, %eax           #  97    0x141155  2      OPC=subl_r32_r32    
  retq                      #  98    0x141157  1      OPC=retq            
