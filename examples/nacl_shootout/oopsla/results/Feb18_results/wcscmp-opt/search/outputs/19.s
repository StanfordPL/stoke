...
.L_141120:                  #        0x141111  0      OPC=<label>        
  movl %esi, %esi           #  45    0x141111  2      OPC=movl_r32_r32   
  movl (%r15,%rsi,1), %edx  #  46    0x141113  4      OPC=movl_r32_m32   
  movl %edi, %edi           #  47    0x141117  2      OPC=movl_r32_r32   
  movl (%r15,%rdi,1), %eax  #  48    0x141119  4      OPC=movl_r32_m32   
  addl $0x4, %esi           #  49    0x14111d  3      OPC=addl_r32_imm8  
  cmpl %edx, %eax           #  50    0x141120  2      OPC=cmpl_r32_r32   
  jne .L_141160             #  51    0x141122  2      OPC=jne_label      
  testl %eax, %eax          #  52    0x141124  2      OPC=testl_r32_r32  
  jne .L_141100             #  53    0x141126  2      OPC=jne_label      
  ...
  nop                       #  62    0x141130  1      OPC=nop            
  retq                      #  63    0x141131  1      OPC=retq           
  nop                       #  64    0x141132  1      OPC=nop            
  nop                       #  65    0x141133  1      OPC=nop            
  nop                       #  66    0x141134  1      OPC=nop            
  nop                       #  67    0x141135  1      OPC=nop            
  nop                       #  68    0x141136  1      OPC=nop            
  nop                       #  69    0x141137  1      OPC=nop            
...
.L_141160:                  #        0x141146  0      OPC=<label>        
  subl %edx, %eax           #  84    0x141146  2      OPC=subl_r32_r32   
  retq                      #  85    0x141148  1      OPC=retq           
