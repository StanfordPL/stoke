...
.L_141120:                  #        0x1410f4  0      OPC=<label>        
  ...
  nopl %eax                 #  29    0x14110d  3      OPC=nopl_r32       
  nop                       #  30    0x141110  1      OPC=nop            
  nopl %eax                 #  31    0x141111  3      OPC=nopl_r32       
  nopl %eax                 #  32    0x141114  3      OPC=nopl_r32       
  nop                       #  33    0x141117  1      OPC=nop            
  nop                       #  34    0x141118  1      OPC=nop            
  nop                       #  35    0x141119  1      OPC=nop            
  nop                       #  36    0x14111a  1      OPC=nop            
.L_141160:                  #        0x14111b  0      OPC=<label>        
  subl %edx, %eax           #  37    0x14111b  2      OPC=subl_r32_r32   
  nop                       #  38    0x14111d  1      OPC=nop            
  nop                       #  39    0x14111e  1      OPC=nop            
  nop                       #  40    0x14111f  1      OPC=nop            
  retq                      #  41    0x141120  1      OPC=retq           
