...
.wcscpy:                    #        0x140ee0  0      OPC=<label>         
  ...
  movq %rax, %rdx           #  7     0x140ee7  3      OPC=movq_r64_r64    
  nop                       #  8     0x140eea  1      OPC=nop             
  nop                       #  9     0x140eeb  1      OPC=nop             
  nop                       #  10    0x140eec  1      OPC=nop             
  nop                       #  11    0x140eed  1      OPC=nop             
  movl %esi, %esi           #  12    0x140eee  2      OPC=movl_r32_r32    
  movl (%r15,%rsi,1), %ecx  #  13    0x140ef0  4      OPC=movl_r32_m32    
  nop                       #  14    0x140ef4  1      OPC=nop             
  testl %ecx, %ecx          #  15    0x140ef5  2      OPC=testl_r32_r32   
  nop                       #  16    0x140ef7  1      OPC=nop             
  nop                       #  17    0x140ef8  1      OPC=nop             
  je .L_140f20              #  18    0x140ef9  2      OPC=je_label        
  nop                       #  19    0x140efb  1      OPC=nop             
...
.L_140f00:                  #        0x140f01  0      OPC=<label>         
  movl %edx, %edx           #  25    0x140f01  2      OPC=movl_r32_r32    
  movl %ecx, (%r15,%rdx,1)  #  26    0x140f03  4      OPC=movl_m32_r32    
  addl $0x4, %edx           #  27    0x140f07  3      OPC=addl_r32_imm8   
  addl $0x4, %esi           #  28    0x140f0a  3      OPC=addl_r32_imm8   
  movl (%r15,%rsi,1), %ecx  #  29    0x140f0d  4      OPC=movl_r32_m32    
  testl %ecx, %ecx          #  30    0x140f11  2      OPC=testl_r32_r32   
  jne .L_140f00             #  31    0x140f13  2      OPC=jne_label       
  ...
  xorb %ch, %ah             #  39    0x140f1c  2      OPC=xorb_rh_rh      
