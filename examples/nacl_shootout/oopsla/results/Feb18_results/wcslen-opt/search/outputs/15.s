...
.wcslen:                    #        0x142ca0  0      OPC=<label>        
  ...
  orl %edi, %edi            #  4     0x142ca4  2      OPC=orl_r32_r32_1  
  ...
  movq %rdi, %rdx           #  23    0x142cbd  3      OPC=movq_r64_r64   
  nop                       #  24    0x142cc0  1      OPC=nop            
.L_142cc0:                  #        0x142cc1  0      OPC=<label>        
  addl $0x4, %edx           #  25    0x142cc1  3      OPC=addl_r32_imm8  
  movl (%r15,%rdx,1), %eax  #  26    0x142cc4  4      OPC=movl_r32_m32   
  testl %eax, %edi          #  27    0x142cc8  2      OPC=testl_r32_r32  
  jne .L_142cc0             #  28    0x142cca  2      OPC=jne_label      
  movl %edx, %eax           #  29    0x142ccc  2      OPC=movl_r32_r32   
  subl %edi, %eax           #  30    0x142cce  2      OPC=subl_r32_r32   
  nop                       #  31    0x142cd0  1      OPC=nop            
  nop                       #  32    0x142cd1  1      OPC=nop            
  sarl $0x2, %eax           #  33    0x142cd2  3      OPC=sarl_r32_imm8  
  nop                       #  34    0x142cd5  1      OPC=nop            
  nopl %eax                 #  35    0x142cd6  3      OPC=nopl_r32       
  nop                       #  36    0x142cd9  1      OPC=nop            
  nop                       #  37    0x142cda  1      OPC=nop            
  nop                       #  38    0x142cdb  1      OPC=nop            
  nop                       #  39    0x142cdc  1      OPC=nop            
  nopl %eax                 #  40    0x142cdd  3      OPC=nopl_r32       
.L_142ce0:                  #        0x142ce0  0      OPC=<label>        
  retq                      #  41    0x142ce0  1      OPC=retq           
