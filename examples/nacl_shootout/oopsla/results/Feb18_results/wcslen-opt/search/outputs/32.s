...
.L_142cc0:                  #        0x142cb3  0      OPC=<label>        
  ...
  movl %edx, %edx           #  11    0x142cb6  2      OPC=movl_r32_r32   
  movl (%r15,%rdx,1), %eax  #  12    0x142cb8  4      OPC=movl_r32_m32   
  testl %eax, %edi          #  13    0x142cbc  2      OPC=testl_r32_r32  
  jne .L_142cc0             #  14    0x142cbe  2      OPC=jne_label      
  movl %edx, %eax           #  15    0x142cc0  2      OPC=movl_r32_r32   
  subl %edi, %eax           #  16    0x142cc2  2      OPC=subl_r32_r32   
  sarl $0x2, %eax           #  17    0x142cc4  3      OPC=sarl_r32_imm8  
  nop                       #  18    0x142cc7  1      OPC=nop            
  nop                       #  19    0x142cc8  1      OPC=nop            
  nop                       #  20    0x142cc9  1      OPC=nop            
  ...
  nop                       #  26    0x142ccf  1      OPC=nop            
  nop                       #  27    0x142cd0  1      OPC=nop            
  nop                       #  28    0x142cd1  1      OPC=nop            
  nop                       #  29    0x142cd2  1      OPC=nop            
.L_142ce0:                  #        0x142cd3  0      OPC=<label>        
  retq                      #  30    0x142cd3  1      OPC=retq           
