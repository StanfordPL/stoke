...
.wcslen:                    #        0x142ca0  0      OPC=<label>        
  ...
  movl %edi, %edi           #  5     0x142ca6  2      OPC=movl_r32_r32   
  movl (%r15,%rdi,1), %ecx  #  6     0x142ca8  4      OPC=movl_r32_m32   
  movq %rdi, %rdx           #  7     0x142cac  3      OPC=movq_r64_r64   
  testl %ecx, %ecx          #  8     0x142caf  2      OPC=testl_r32_r32  
  je .L_142ce0              #  9     0x142cb1  2      OPC=je_label       
  ...
  nop                       #  23    0x142cc0  1      OPC=nop            
  nop                       #  24    0x142cc1  1      OPC=nop            
.L_142cc0:                  #        0x142cc2  0      OPC=<label>        
  addl $0x4, %edx           #  25    0x142cc2  3      OPC=addl_r32_imm8  
  movl (%r15,%rdx,1), %eax  #  26    0x142cc5  4      OPC=movl_r32_m32   
  testl %eax, %eax          #  27    0x142cc9  2      OPC=testl_r32_r32  
  jne .L_142cc0             #  28    0x142ccb  2      OPC=jne_label      
  movl %edx, %eax           #  29    0x142ccd  2      OPC=movl_r32_r32   
