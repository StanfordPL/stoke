...
.wcsnlen:                   #        0x142d00  0      OPC=<label>        
  ...
  nop                       #  2     0x142d02  1      OPC=nop            
  movl %edi, %edi           #  3     0x142d03  2      OPC=movl_r32_r32   
  movl (%r15,%rdi,1), %ecx  #  4     0x142d05  4      OPC=movl_r32_m32   
  testl %ecx, %ecx          #  5     0x142d09  2      OPC=testl_r32_r32  
  je .L_142d80              #  6     0x142d0b  2      OPC=je_label       
  testl %esi, %esi          #  7     0x142d0d  2      OPC=testl_r32_r32  
  je .L_142d80              #  8     0x142d0f  2      OPC=je_label       
  movq %rdi, %rax           #  9     0x142d11  3      OPC=movq_r64_r64   
  nop                       #  10    0x142d14  1      OPC=nop            
  subl $0x1, %esi           #  11    0x142d15  3      OPC=subl_r32_imm8  
