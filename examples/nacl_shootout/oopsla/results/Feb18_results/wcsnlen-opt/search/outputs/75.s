...
.wcsnlen:                   #        0x142d00  0      OPC=<label>         
  ...
  movq %rdi, %rax           #  9     0x142d14  3      OPC=movq_r64_r64    
  jmpq .L_142d40            #  10    0x142d17  2      OPC=jmpq_label      
  nop                       #  11    0x142d19  1      OPC=nop             
...
.L_142d40:                  #        0x142d37  0      OPC=<label>         
  ...
  movl %eax, %eax           #  38    0x142d3a  2      OPC=movl_r32_r32    
  movl (%r15,%rax,1), %edx  #  39    0x142d3c  4      OPC=movl_r32_m32    
  testl %edx, %edx          #  40    0x142d40  2      OPC=testl_r32_r32   
  jne .L_142d20             #  41    0x142d42  2      OPC=jne_label       
...
.L_142d60:                  #        0x142d48  0      OPC=<label>         
  subl %edi, %eax           #  46    0x142d48  2      OPC=subl_r32_r32    
  sarl $0x2, %eax           #  47    0x142d4a  3      OPC=sarl_r32_imm8   
  retq                      #  48    0x142d4d  1      OPC=retq            
  nop                       #  49    0x142d4e  1      OPC=nop             
  nop                       #  50    0x142d4f  1      OPC=nop             
  nop                       #  51    0x142d50  1      OPC=nop             
  nop                       #  52    0x142d51  1      OPC=nop             
  nop                       #  53    0x142d52  1      OPC=nop             
.L_142d80:                  #        0x142d53  0      OPC=<label>         
  xorl %eax, %eax           #  54    0x142d53  2      OPC=xorl_r32_r32    
  retq                      #  55    0x142d55  1      OPC=retq            
