...
.wcsrchr:                   #        0x1438c0  0      OPC=<label>        
  ...
  movq %rdi, %rax           #  6     0x1438ca  3      OPC=movq_r64_r64   
  nop                       #  7     0x1438cd  1      OPC=nop            
  je .L_143900              #  8     0x1438ce  2      OPC=je_label       
  xchgw %di, %ax            #  9     0x1438d0  2      OPC=xchgw_ax_r16   
...
.L_1438e0:                  #        0x1438e3  0      OPC=<label>        
  addl $0x4, %eax           #  27    0x1438e3  3      OPC=addl_r32_imm8  
  movl (%r15,%rax,1), %edx  #  28    0x1438e6  4      OPC=movl_r32_m32   
  testl %edx, %edx          #  29    0x1438ea  2      OPC=testl_r32_r32  
  jne .L_1438e0             #  30    0x1438ec  2      OPC=jne_label      
  cmpl %eax, %edi           #  31    0x1438ee  2      OPC=cmpl_r32_r32   
  ja .L_143960              #  32    0x1438f0  2      OPC=ja_label       
  ...
  nopl %eax                 #  44    0x1438fd  3      OPC=nopl_r32       
...
.L_143920:                  #        0x143922  0      OPC=<label>        
  movl %eax, %eax           #  73    0x143922  2      OPC=movl_r32_r32   
  cmpl %esi, (%r15,%rax,1)  #  74    0x143924  4      OPC=cmpl_m32_r32   
  je .L_143980              #  75    0x143928  2      OPC=je_label       
...
.L_143940:                  #        0x143932  0      OPC=<label>        
  subl $0x4, %eax           #  84    0x143932  3      OPC=subl_r32_imm8  
  cmpl %eax, %edi           #  85    0x143935  2      OPC=cmpl_r32_r32   
  jbe .L_143920             #  86    0x143937  2      OPC=jbe_label      
  nop                       #  87    0x143939  1      OPC=nop            
  nop                       #  88    0x14393a  1      OPC=nop            
  nop                       #  89    0x14393b  1      OPC=nop            
  nop                       #  90    0x14393c  1      OPC=nop            
  nop                       #  91    0x14393d  1      OPC=nop            
  nop                       #  92    0x14393e  1      OPC=nop            
  nop                       #  93    0x14393f  1      OPC=nop            
  nop                       #  94    0x143940  1      OPC=nop            
  nop                       #  95    0x143941  1      OPC=nop            
  nop                       #  96    0x143942  1      OPC=nop            
  nop                       #  97    0x143943  1      OPC=nop            
  nop                       #  98    0x143944  1      OPC=nop            
  nop                       #  99    0x143945  1      OPC=nop            
  nop                       #  100   0x143946  1      OPC=nop            
  nop                       #  101   0x143947  1      OPC=nop            
...
.L_143960:                  #        0x143950  0      OPC=<label>        
  ...
  xorl %eax, %eax           #  132   0x143966  2      OPC=xorl_r32_r32   
...
.L_143980:                  #        0x143971  0      OPC=<label>        
  retq                      #  142   0x143971  1      OPC=retq           
