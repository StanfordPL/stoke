...
.L_140ae0:                  #        0x140ae7  0      OPC=<label>        
  movl %esi, %esi           #  39    0x140ae7  2      OPC=movl_r32_r32   
  movl (%r15,%rsi,1), %edx  #  40    0x140ae9  4      OPC=movl_r32_m32   
  movq %rdi, %rax           #  41    0x140aed  3      OPC=movq_r64_r64   
  addl $0x4, %esi           #  42    0x140af0  3      OPC=addl_r32_imm8  
  movl %edi, %edi           #  43    0x140af3  2      OPC=movl_r32_r32   
  movl %edx, (%r15,%rdi,1)  #  44    0x140af5  4      OPC=movl_m32_r32   
  addl $0x4, %edi           #  45    0x140af9  3      OPC=addl_r32_imm8  
  testl %edx, %edx          #  46    0x140afc  2      OPC=testl_r32_r32  
  jne .L_140ae0             #  47    0x140afe  2      OPC=jne_label      
  retq                      #  48    0x140b00  1      OPC=retq           
  ...
  nop                       #  54    0x140b06  1      OPC=nop            
  nop                       #  55    0x140b07  1      OPC=nop            
  nop                       #  56    0x140b08  1      OPC=nop            
  nop                       #  57    0x140b09  1      OPC=nop            
  nop                       #  58    0x140b0a  1      OPC=nop            
  nop                       #  59    0x140b0b  1      OPC=nop            
  nop                       #  60    0x140b0c  1      OPC=nop            
  nop                       #  61    0x140b0d  1      OPC=nop            
  nop                       #  62    0x140b0e  1      OPC=nop            
  nop                       #  63    0x140b0f  1      OPC=nop            
  nop                       #  64    0x140b10  1      OPC=nop            
  nop                       #  65    0x140b11  1      OPC=nop            
  nop                       #  66    0x140b12  1      OPC=nop            
  nop                       #  67    0x140b13  1      OPC=nop            
  nop                       #  68    0x140b14  1      OPC=nop            
