...
.L_140ae0:                      #        0x140ad5  0      OPC=<label>        
  ...
  testl %edx, %edx              #  27    0x140ae8  2      OPC=testl_r32_r32  
  jne .L_140ae0                 #  28    0x140aea  2      OPC=jne_label      
  retq                          #  29    0x140aec  1      OPC=retq           
  nop                           #  30    0x140aed  1      OPC=nop            
  nop                           #  31    0x140aee  1      OPC=nop            
  nop                           #  32    0x140aef  1      OPC=nop            
  nop                           #  33    0x140af0  1      OPC=nop            
  nop                           #  34    0x140af1  1      OPC=nop            
  nop                           #  35    0x140af2  1      OPC=nop            
  nop                           #  36    0x140af3  1      OPC=nop            
  nop                           #  37    0x140af4  1      OPC=nop            
  nop                           #  38    0x140af5  1      OPC=nop            
  nop                           #  39    0x140af6  1      OPC=nop            
  nop                           #  40    0x140af7  1      OPC=nop            
  nop                           #  41    0x140af8  1      OPC=nop            
  nop                           #  42    0x140af9  1      OPC=nop            
  nop                           #  43    0x140afa  1      OPC=nop            
  nop                           #  44    0x140afb  1      OPC=nop            
  nop                           #  45    0x140afc  1      OPC=nop            
  nop                           #  46    0x140afd  1      OPC=nop            
  nop                           #  47    0x140afe  1      OPC=nop            
  subb %dh, %dh                 #  48    0x140aff  2      OPC=subb_rh_rh     
