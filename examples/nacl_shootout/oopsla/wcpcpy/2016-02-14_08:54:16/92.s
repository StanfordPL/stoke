...
.wcpcpy:                    #        0x140ac0  0      OPC=<label>        
  ...
  movl %esi, %esi           #  17    0x140ad1  2      OPC=movl_r32_r32   
  ...
  nop                       #  32    0x140ae1  1      OPC=nop            
  nop                       #  33    0x140ae2  1      OPC=nop            
  nop                       #  34    0x140ae3  1      OPC=nop            
  nop                       #  35    0x140ae4  1      OPC=nop            
  nop                       #  36    0x140ae5  1      OPC=nop            
  nop                       #  37    0x140ae6  1      OPC=nop            
.L_140ae0:                  #        0x140ae7  0      OPC=<label>        
  movl %esi, %esi           #  38    0x140ae7  2      OPC=movl_r32_r32   
  movl (%r15,%rsi,1), %edx  #  39    0x140ae9  4      OPC=movl_r32_m32   
  movq %rdi, %rax           #  40    0x140aed  3      OPC=movq_r64_r64   
  addl $0x4, %esi           #  41    0x140af0  3      OPC=addl_r32_imm8  
  movl %edi, %edi           #  42    0x140af3  2      OPC=movl_r32_r32   
  movl %edx, (%r15,%rdi,1)  #  43    0x140af5  4      OPC=movl_m32_r32   
  addl $0x4, %edi           #  44    0x140af9  3      OPC=addl_r32_imm8  
  testl %edx, %edx          #  45    0x140afc  2      OPC=testl_r32_r32  
  jne .L_140ae0             #  46    0x140afe  2      OPC=jne_label      
  retq                      #  47    0x140b00  1      OPC=retq           
  ...
  nop                       #  63    0x140b10  1      OPC=nop            
  nop                       #  64    0x140b11  1      OPC=nop            
  nop                       #  65    0x140b12  1      OPC=nop            
  nop                       #  66    0x140b13  1      OPC=nop            
  nop                       #  67    0x140b14  1      OPC=nop            
  nop                       #  68    0x140b15  1      OPC=nop            
  nop                       #  69    0x140b16  1      OPC=nop            
  nop                       #  70    0x140b17  1      OPC=nop            
  nop                       #  71    0x140b18  1      OPC=nop            
  nop                       #  72    0x140b19  1      OPC=nop            
