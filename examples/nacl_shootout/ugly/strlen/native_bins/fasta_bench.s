...
.fasta_bench:               #        0x401dfa  0      OPC=0     
  ...
  movl $0x408224, %esi      #  8     0x401e0f  5      OPC=1154  
  movl $0x408280, %edi      #  9     0x401e14  5      OPC=1154  
  callq .repeat             #  10    0x401e19  5      OPC=260   
  leal (%rbp,%rbx,1), %ecx  #  11    0x401e1e  4      OPC=1066  
  leaq 0xc(%rsp), %r8       #  12    0x401e22  5      OPC=1069  
  movl $0x40823b, %edx      #  13    0x401e27  5      OPC=1154  
  ...
  movl $0x408258, %edx      #  19    0x401e43  5      OPC=1154  
