...
.ht_node_create_part_3:     #        0x4017d0  0      OPC=0     
  ...
  movl $0x4084aa, %edi      #  2     0x4017d1  5      OPC=1154  
  callq .perror_plt         #  3     0x4017d6  5      OPC=260   
  movl $0x408560, %ecx      #  4     0x4017db  5      OPC=1154  
  movl $0x56, %edx          #  5     0x4017e0  5      OPC=1154  
  movl $0x4084b9, %esi      #  6     0x4017e5  5      OPC=1154  
  movl $0x408e15, %edi      #  7     0x4017ea  5      OPC=1154  
