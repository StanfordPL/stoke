...
.L_10:                          #        0x20  0      OPC=<label>              
  ...
  orb %dh, %ah                  #  27    0x21  2      OPC=orb_rh_rh            
  ...
  jne .L_60                     #  42    0x34  2      OPC=jne_label            
  nop                           #  43    0x36  1      OPC=nop                  
  nop                           #  44    0x37  1      OPC=nop                  
  nop                           #  45    0x38  1      OPC=nop                  
  nop                           #  46    0x39  1      OPC=nop                  
  nop                           #  47    0x3a  1      OPC=nop                  
  testl %edx, %edx              #  48    0x3b  2      OPC=testl_r32_r32        
  nop                           #  49    0x3d  1      OPC=nop                  
  je .L_60                      #  50    0x3e  2      OPC=je_label             
.L_18:                          #        0x40  0      OPC=<label>              
  addq $0x1, %rdi               #  51    0x40  4      OPC=addq_r64_imm8        
  leal -0x1(%rdi), %r9d         #  52    0x44  4      OPC=leal_r32_m32         
  movzbq (%r15,%r9,1), %rdx     #  53    0x48  5      OPC=movzbq_r64_m8        
  movq %rdx, %rax               #  54    0x4d  3      OPC=movq_r64_r64         
  leaq 0x20(%rax), %rcx         #  55    0x50  4      OPC=leaq_r64_m64         
  nop                           #  56    0x54  1      OPC=nop                  
  ...
  addq $0x1, %rsi               #  65    0x6c  4      OPC=addq_r64_imm8        
  leal -0x1(%rsi), %r9d         #  66    0x70  4      OPC=leal_r32_m16         
  movzbw (%r15,%r9,1), %cx      #  67    0x74  6      OPC=movzbw_r16_m8        
  movq %rcx, %rdx               #  68    0x7a  3      OPC=movq_r64_r64_1       
  nop                           #  69    0x7d  1      OPC=nop                  
  nop                           #  70    0x7e  1      OPC=nop                  
  nop                           #  71    0x7f  1      OPC=nop                  
  ...
  jne .L_10                     #  76    0x90  2      OPC=jne_label            
