...
(two of the target and one of the rewrite). \todo{rewrite this using
cutpoint terminology} For this example, that approach fails unless the
...
reasoning about arbitrary branch conditions.\todo{this needs further
clarification, especially around point (i) which is the bigger
problem}
