...
/* /home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/expr/expr_template.h */
...
#include <cvc4/util/uninterpreted_constant.h>
#include <cvc4/util/abstract_value.h>
#include <cvc4/expr/kind.h>
#include <cvc4/util/chain.h>
#include <cvc4/expr/kind.h>
#include <cvc4/util/predicate.h>
...
#include <cvc4/util/bitvector.h>
#include <cvc4/util/bitvector.h>
#include <cvc4/util/array_store_all.h>
#include <cvc4/util/datatype.h>
#include <cvc4/util/ascription_type.h>
#include <cvc4/util/tuple.h>
#include <cvc4/util/tuple.h>
#include <cvc4/util/record.h>
#include <cvc4/util/record.h>
#include <cvc4/util/record.h>
#include <cvc4/util/emptyset.h>
...
#include <cvc4/expr/options.h>

// This is a hack, but an important one: if there's an error, the
// compiler directs the user to the template file instead of the
// generated one.  We don't want the user to modify the generated one,
// since it'll get overwritten on a later build.
#line 44 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/expr/expr_template.h"
...
#line 266 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/builtin/kinds"
template <> ::CVC4::UninterpretedConstant const & Expr::getConst< ::CVC4::UninterpretedConstant >() const;

#line 276 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/builtin/kinds"
template <> ::CVC4::AbstractValue const & Expr::getConst< ::CVC4::AbstractValue >() const;

#line 287 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/builtin/kinds"
template <> ::CVC4::Kind const & Expr::getConst< ::CVC4::Kind >() const;

#line 309 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/builtin/kinds"
template <> ::CVC4::Chain const & Expr::getConst< ::CVC4::Chain >() const;

#line 315 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/builtin/kinds"
template <> ::CVC4::TypeConstant const & Expr::getConst< ::CVC4::TypeConstant >() const;

#line 343 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/builtin/kinds"
template <> ::CVC4::Predicate const & Expr::getConst< ::CVC4::Predicate >() const;

#line 21 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/booleans/kinds"
template <> bool const & Expr::getConst< bool >() const;

#line 29 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/arith/kinds"
template <> ::CVC4::Divisible const & Expr::getConst< ::CVC4::Divisible >() const;

#line 48 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/arith/kinds"
template <> ::CVC4::SubrangeBounds const & Expr::getConst< ::CVC4::SubrangeBounds >() const;

#line 61 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/arith/kinds"
template <> ::CVC4::Rational const & Expr::getConst< ::CVC4::Rational >() const;

#line 15 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/bv/kinds"
template <> ::CVC4::BitVectorSize const & Expr::getConst< ::CVC4::BitVectorSize >() const;

#line 24 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/bv/kinds"
template <> ::CVC4::BitVector const & Expr::getConst< ::CVC4::BitVector >() const;

#line 77 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/bv/kinds"
template <> ::CVC4::BitVectorBitOf const & Expr::getConst< ::CVC4::BitVectorBitOf >() const;

#line 83 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/bv/kinds"
template <> ::CVC4::BitVectorExtract const & Expr::getConst< ::CVC4::BitVectorExtract >() const;

#line 89 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/bv/kinds"
template <> ::CVC4::BitVectorRepeat const & Expr::getConst< ::CVC4::BitVectorRepeat >() const;

#line 95 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/bv/kinds"
template <> ::CVC4::BitVectorZeroExtend const & Expr::getConst< ::CVC4::BitVectorZeroExtend >() const;

#line 101 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/bv/kinds"
template <> ::CVC4::BitVectorSignExtend const & Expr::getConst< ::CVC4::BitVectorSignExtend >() const;

#line 107 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/bv/kinds"
template <> ::CVC4::BitVectorRotateLeft const & Expr::getConst< ::CVC4::BitVectorRotateLeft >() const;

#line 113 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/bv/kinds"
template <> ::CVC4::BitVectorRotateRight const & Expr::getConst< ::CVC4::BitVectorRotateRight >() const;

#line 127 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/bv/kinds"
template <> ::CVC4::IntToBitVector const & Expr::getConst< ::CVC4::IntToBitVector >() const;

#line 35 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/arrays/kinds"
template <> ::CVC4::ArrayStoreAll const & Expr::getConst< ::CVC4::ArrayStoreAll >() const;

#line 45 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/datatypes/kinds"
template <> ::CVC4::Datatype const & Expr::getConst< ::CVC4::Datatype >() const;

#line 77 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/datatypes/kinds"
template <> ::CVC4::AscriptionType const & Expr::getConst< ::CVC4::AscriptionType >() const;

#line 108 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/datatypes/kinds"
template <> ::CVC4::TupleSelect const & Expr::getConst< ::CVC4::TupleSelect >() const;

#line 116 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/datatypes/kinds"
template <> ::CVC4::TupleUpdate const & Expr::getConst< ::CVC4::TupleUpdate >() const;

#line 124 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/datatypes/kinds"
template <> ::CVC4::Record const & Expr::getConst< ::CVC4::Record >() const;

#line 144 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/datatypes/kinds"
template <> ::CVC4::RecordSelect const & Expr::getConst< ::CVC4::RecordSelect >() const;

#line 152 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/datatypes/kinds"
template <> ::CVC4::RecordUpdate const & Expr::getConst< ::CVC4::RecordUpdate >() const;

#line 18 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/sets/kinds"
template <> ::CVC4::EmptySet const & Expr::getConst< ::CVC4::EmptySet >() const;

#line 62 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/strings/kinds"
template <> ::CVC4::String const & Expr::getConst< ::CVC4::String >() const;

#line 68 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/theory/strings/kinds"
template <> ::CVC4::RegExp const & Expr::getConst< ::CVC4::RegExp >() const;


#line 938 "/home/berkeley/stoke/src/ext/cvc4-1.4/builds/x86_64-unknown-linux-gnu/production-cln-nodebugsymbols-nostatistics-noassertions-notracing/../../../src/expr/expr_template.h"
