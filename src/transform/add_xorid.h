...
#ifndef STOKE_SRC_TRANSFORM_ADD_XORID_H
#define STOKE_SRC_TRANSFORM_ADD_XORID_H
...
class AddXorIdTransform : public Transform {
...
public:
  ...
  AddXorIdTransform(TransformPools& pools) : Transform(pools) { }
