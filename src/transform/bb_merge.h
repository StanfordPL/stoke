...
#ifndef STOKE_SRC_TRANSFORM_BB_MERGE_H
#define STOKE_SRC_TRANSFORM_BB_MERGE_H
...
class BbMergeTransform : public Transform {
...
public:
  ...
  BbMergeTransform(TransformPools& pools) : Transform(pools) { }
