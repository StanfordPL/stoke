...
#ifndef STOKE_SRC_TRANSFORM_DELETE_RANGE_H
#define STOKE_SRC_TRANSFORM_DELETE_RANGE_H
...
class DeleteRangeTransform : public Transform {
...
public:
  ...
  DeleteRangeTransform(TransformPools& pools) : Transform(pools) { }
