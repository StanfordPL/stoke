...
#ifndef STOKE_SRC_TRANSFORM_DOUBLE_H
#define STOKE_SRC_TRANSFORM_DOUBLE_H
...
public:
  ...
  DoubleTransform(TransformPools& pools, std::mt19937_64* generator) : Transform(pools, generator) { }
