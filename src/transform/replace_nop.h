...
#ifndef STOKE_SRC_TRANSFORM_REPLACE_NOP_H
#define STOKE_SRC_TRANSFORM_REPLACE_NOP_H
...
class ReplaceNopTransform : public Transform {
...
public:
  ...
  ReplaceNopTransform(TransformPools& pools) : Transform(pools) { }
