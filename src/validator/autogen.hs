...
lookup_handler "clc"      _ _ = Just "setFlag(d.vc, d.Vnprime,V_CF, vc_falseExpr(d.vc), d.constraints, d.post_suffix);"
lookup_handler "cltd"     _ _ = Just "cwd_cdq_cqoHandler(d, 32);"
lookup_handler "cltq"     _ _ = Just "convert_e_Handler(d, 32);"
lookup_handler "cmc"      _ _ = Just "setFlag(d.vc, d.Vnprime,V_CF, vc_notExpr(d.vc, getBoolExpr(d.vc,V_CF,d.pre_suffix, d.Vn)), d.constraints, d.post_suffix);"
lookup_handler "cmovael"  _ _ = Just "cmovaeHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovaeq"  _ _ = Just "cmovaeHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovaew"  _ _ = Just "cmovaeHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmoval"   _ _ = Just "cmovaHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovaq"   _ _ = Just "cmovaHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovaw"   _ _ = Just "cmovaHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovbel"  _ _ = Just "cmovbeHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovbeq"  _ _ = Just "cmovbeHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovbew"  _ _ = Just "cmovbeHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovbl"   _ _ = Just "cmovbHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovbq"   _ _ = Just "cmovbHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovbw"   _ _ = Just "cmovbHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovel"   _ _ = Just "cmoveHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmoveq"   _ _ = Just "cmoveHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovew"   _ _ = Just "cmoveHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovgel"  _ _ = Just "cmovgeHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovgeq"  _ _ = Just "cmovgeHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovgew"  _ _ = Just "cmovgeHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovgl"   _ _ = Just "cmovgHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovgq"   _ _ = Just "cmovgHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovgw"   _ _ = Just "cmovgHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovlel"  _ _ = Just "cmovleHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovleq"  _ _ = Just "cmovleHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovlew"  _ _ = Just "cmovleHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovll"   _ _ = Just "cmovlHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovlq"   _ _ = Just "cmovlHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovlw"   _ _ = Just "cmovlHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovnel"  _ _ = Just "cmovneHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovneq"  _ _ = Just "cmovneHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovnew"  _ _ = Just "cmovneHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovnsl"  _ _ = Just "cmovnsHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovnsq"  _ _ = Just "cmovnsHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovnsw"  _ _ = Just "cmovnsHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovsl"   _ _ = Just "cmovsHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovsq"   _ _ = Just "cmovsHandler(d, bitWidth, E1, E0, E2);"
lookup_handler "cmovsw"   _ _ = Just "cmovsHandler(d, bitWidth, E1, E0, E2);"
...
lookup_handler "divl"     _ _ = Just "div_uif_Handler(d, bitWidth, E0);"
...
lookup_handler "ja"       _ _ = Just "d.constraints.push_back(vc_andExpr(d.vc, vc_notExpr(d.vc, getBoolExpr(d.vc,V_CF,d.pre_suffix, d.Vn)), vc_notExpr(d.vc, getBoolExpr(d.vc,V_ZF,d.pre_suffix, d.Vn))));"
lookup_handler "jae"      _ _ = Just "d.constraints.push_back(vc_notExpr(d.vc, getBoolExpr(d.vc,V_CF,d.pre_suffix, d.Vn)));"
...
lookup_handler "jl"       _ _ = Just "d.constraints.push_back(vc_notExpr(d.vc, vc_iffExpr(d.vc, getBoolExpr(d.vc,V_SF,d.pre_suffix, d.Vn), getBoolExpr(d.vc,V_OF,d.pre_suffix, d.Vn))));"
lookup_handler "jne"      _ _ = Just "d.constraints.push_back(vc_notExpr(d.vc, getBoolExpr(d.vc,V_ZF,d.pre_suffix, d.Vn)));"
...
lookup_handler "roll"     2 i = Just $ if (((last (operand_types i)) == "I")) then "rolHandler(d, bitWidth, imm & 0x1f,   E1, E0, dest_is_reg);" else ""
lookup_handler "rorl"     2 i = Just $ if (((last (operand_types i)) == "I")) then "rorHandler(d, bitWidth, imm & 0x1f,   E1, E0, dest_is_reg);" else ""
lookup_handler "sahf"     _ _ = Just "sahfHandler(d);"
lookup_handler "salb"     1 _ = Just "shlHandler(d,bitWidth, 1, E1,E0,dest_is_reg);"
lookup_handler "salb"     2 i = Just $ if (((last (operand_types i)) == "I")) then "shlHandler(d, bitWidth, imm,  E1, E0, dest_is_reg);" else ""
lookup_handler "sall"     1 _ = Just "shlHandler(d,bitWidth, 1, E1,E0,dest_is_reg);" 
lookup_handler "sall"     2 i = Just $ if (((last (operand_types i)) == "I")) then "shlHandler(d, bitWidth, imm&0x1f,  E1, E0, dest_is_reg);" else "shlVarHandler(d, bitWidth, E1, E0, dest_is_reg);"
lookup_handler "salq"     1 _ = Just "shlHandler(d,bitWidth, 1, E1,E0,dest_is_reg);"
lookup_handler "salq"     2 i = Just $ if (((last (operand_types i)) == "I")) then "shlHandler(d, bitWidth, imm&0x3f,  E1, E0, dest_is_reg);" else ""
lookup_handler "salw"     1 _ = Just "shlHandler(d,bitWidth, 1, E1,E0,dest_is_reg);"
lookup_handler "salw"     2 i = Just $ if (((last (operand_types i)) == "I")) then "shlHandler(d, bitWidth, imm,  E1, E0, dest_is_reg);" else ""
lookup_handler "sarb"     1 _ = Just "sarHandler(d,bitWidth, 1, E1,E0,dest_is_reg);"
lookup_handler "sarb"     2 i = Just $ if (((last (operand_types i)) == "I")) then "sarHandler(d, bitWidth, imm,  E1, E0, dest_is_reg);" else ""
lookup_handler "sarl"     1 _ = Just "sarHandler(d,bitWidth, 1, E1,E0,dest_is_reg);"
lookup_handler "sarl"     2 i = Just $ if (((last (operand_types i)) == "I")) then "sarHandler(d, bitWidth, imm&0x1f,  E1, E0, dest_is_reg);" else ""
lookup_handler "sarq"     1 _ = Just "sarHandler(d,bitWidth, 1, E1,E0,dest_is_reg);"
lookup_handler "sarq"     2 i = Just $ if (((last (operand_types i)) == "I")) then "sarHandler(d, bitWidth, imm&0x3f,  E1, E0, dest_is_reg);" else ""
lookup_handler "sarw"     1 _ = Just "sarHandler(d,bitWidth, 1, E1,E0,dest_is_reg);"
lookup_handler "sarw"     2 i = Just $ if (((last (operand_types i)) == "I")) then "sarHandler(d, bitWidth, imm,  E1, E0, dest_is_reg);" else ""
...
lookup_handler "seta"     _ _ = Just "setaHandler(d, bitWidth, E0, dest_is_reg);"
lookup_handler "setae"    _ _ = Just "setaeHandler(d, bitWidth, E0, dest_is_reg);"
lookup_handler "setb"     _ _ = Just "setbHandler(d, bitWidth, E0, dest_is_reg);"
lookup_handler "setbe"    _ _ = Just "setbeHandler(d, bitWidth, E0, dest_is_reg);"
lookup_handler "sete"     _ _ = Just "seteHandler(d, bitWidth, E0, dest_is_reg);"
lookup_handler "setg"     _ _ = Just "setgHandler(d, bitWidth, E0, dest_is_reg);"
lookup_handler "setge"    _ _ = Just "setgeHandler(d, bitWidth, E0, dest_is_reg);"
lookup_handler "setl"     _ _ = Just "setlHandler(d, bitWidth, E0, dest_is_reg);"
lookup_handler "setle"    _ _ = Just "setleHandler(d, bitWidth, E0, dest_is_reg);"
lookup_handler "setne"    _ _ = Just "setneHandler(d, bitWidth, E0, dest_is_reg);"
lookup_handler "setno"    _ _ = Just "setnoHandler(d, bitWidth, E0, dest_is_reg);"
lookup_handler "setnp"    _ _ = Just "setnpHandler(d, bitWidth, E0, dest_is_reg);"
lookup_handler "setns"    _ _ = Just "setnsHandler(d, bitWidth, E0, dest_is_reg);"
lookup_handler "seto"     _ _ = Just "setoHandler(d, bitWidth, E0, dest_is_reg);"
lookup_handler "setp"     _ _ = Just "setpHandler(d, bitWidth, E0, dest_is_reg);"
lookup_handler "sets"     _ _ = Just "setsHandler(d, bitWidth, E0, dest_is_reg);"
lookup_handler "shlb"     1 _ = Just "shlHandler(d,bitWidth, 1, E1,E0,dest_is_reg);"
lookup_handler "shlb"     2 i = Just $ if (((last (operand_types i)) == "I")) then "shlHandler(d, bitWidth, imm,  E1, E0, dest_is_reg);"  else ""
lookup_handler "shld"     _ i = Just $ if (((last (operand_types i)) == "I")) then "shldHandler(d, bitWidth, imm &(bitWidth-1), E1, E0, E2, dest_is_reg);" else "shldHandler(d, bitWidth, E1, E0, E2, E3, dest_is_reg);"
lookup_handler "shll"     1 _ = Just "shlHandler(d,bitWidth, 1, E1,E0,dest_is_reg);"
lookup_handler "shll"     2 i = Just $ if (((last (operand_types i)) == "I")) then "shlHandler(d, bitWidth, imm&0x1f,  E1, E0, dest_is_reg);" else ""
lookup_handler "shlq"     1 _ = Just "shlHandler(d,bitWidth, 1, E1,E0,dest_is_reg);"
lookup_handler "shlq"     2 i = Just $ if (((last (operand_types i)) == "I")) then "shlHandler(d, bitWidth, imm&0x3f,  E1, E0, dest_is_reg);" else ""
lookup_handler "shlw"     1 _ = Just "shlHandler(d,bitWidth, 1, E1,E0,dest_is_reg);"
lookup_handler "shlw"     2 i = Just $ if (((last (operand_types i)) == "I")) then "shlHandler(d, bitWidth, imm,  E1, E0, dest_is_reg);" else ""
lookup_handler "shrb"     1 _ = Just "shrHandler(d,bitWidth, 1, E1,E0,dest_is_reg);"
lookup_handler "shrb"     2 i = Just $ if (((last (operand_types i)) == "I")) then "shrHandler(d, bitWidth, imm,  E1, E0, dest_is_reg);" else ""
lookup_handler "shrl"     1 _ = Just "shrHandler(d,bitWidth, 1, E1,E0,dest_is_reg);"
lookup_handler "shrl"     2 i = Just $ if (((last (operand_types i)) == "I")) then "shrHandler(d, bitWidth, imm&0x1f,  E1, E0, dest_is_reg);" else ""
lookup_handler "shrq"     1 _ = Just "shrHandler(d,bitWidth, 1, E1,E0,dest_is_reg);"
lookup_handler "shrq"     2 i = Just $ if (((last (operand_types i)) == "I")) then "shrHandler(d, bitWidth, imm&0x3f,  E1, E0, dest_is_reg);" else ""
lookup_handler "shrw"     1 _ = Just "shrHandler(d,bitWidth, 1, E1,E0,dest_is_reg);"
lookup_handler "shrw"     2 i = Just $ if (((last (operand_types i)) == "I")) then "shrHandler(d, bitWidth, imm,  E1, E0, dest_is_reg);" else ""
