...
#ifndef STOKE_TOOLS_GADGETS_TRANSFORMS_POOL_H
#define STOKE_TOOLS_GADGETS_TRANSFORMS_POOL_H
...
class TransformsPoolGadget : public TransformsPool {
public:
  TransformsPoolGadget(const Cfg& cfg, const std::vector<TUnit>& aux_fxns,
                       std::default_random_engine::result_type seed) : TransformsPool()
    smt_ = nullptr;
    validator_ = nullptr;
